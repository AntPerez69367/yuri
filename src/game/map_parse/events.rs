...
use super::packet::{encrypt, rfifob, wfifob, wfifohead, wfifop, wfifoset};

use crate::database::item_db;
use crate::game::map_parse::chat::clif_sendmsg;
use crate::game::map_server::{nmail_sendmail, CURRENT_SEASON, CURRENT_YEAR};
...
struct EventRewardRow {
    #[sqlx(rename = "EventName")]
    event_name: String,
    #[sqlx(rename = "EventLegend")]
    event_legend: String,
    #[sqlx(rename = "EventRewardRanks_Display")]
    reward_ranks: i32,
    #[sqlx(rename = "EventLegendIcon1")]
    icon1: i32,
    #[sqlx(rename = "EventLegendIcon1Color")]
    icon1_color: i32,
    #[sqlx(rename = "EventLegendIcon2")]
    icon2: i32,
    #[sqlx(rename = "EventLegendIcon2Color")]
    icon2_color: i32,
    #[sqlx(rename = "EventLegendIcon3")]
    icon3: i32,
    #[sqlx(rename = "EventLegendIcon3Color")]
    icon3_color: i32,
    #[sqlx(rename = "EventLegendIcon4")]
    icon4: i32,
    #[sqlx(rename = "EventLegendIcon4Color")]
    icon4_color: i32,
    #[sqlx(rename = "EventLegendIcon5")]
    icon5: i32,
    #[sqlx(rename = "EventLegendIcon5Color")]
    icon5_color: i32,
    // int(10) unsigned columns — must be u32 or sqlx decode fails silently
    #[sqlx(rename = "1stPlaceReward1_ItmId")]
    r1_itm1: u32,
    #[sqlx(rename = "1stPlaceReward1_Amount")]
    r1_amt1: u32,
    #[sqlx(rename = "1stPlaceReward2_ItmId")]
    r1_itm2: u32,
    #[sqlx(rename = "1stPlaceReward2_Amount")]
    r1_amt2: u32,
    #[sqlx(rename = "2ndPlaceReward1_ItmId")]
    r2_itm1: u32,
    #[sqlx(rename = "2ndPlaceReward1_Amount")]
    r2_amt1: u32,
    #[sqlx(rename = "2ndPlaceReward2_ItmId")]
    r2_itm2: u32,
    #[sqlx(rename = "2ndPlaceReward2_Amount")]
    r2_amt2: u32,
    #[sqlx(rename = "3rdPlaceReward1_ItmId")]
    r3_itm1: u32,
    #[sqlx(rename = "3rdPlaceReward1_Amount")]
    r3_amt1: u32,
    #[sqlx(rename = "3rdPlaceReward2_ItmId")]
    r3_itm2: u32,
    #[sqlx(rename = "3rdPlaceReward2_Amount")]
    r3_amt2: u32,
    #[sqlx(rename = "4thPlaceReward1_ItmId")]
    r4_itm1: u32,
    #[sqlx(rename = "4thPlaceReward1_Amount")]
    r4_amt1: u32,
    #[sqlx(rename = "4thPlaceReward2_ItmId")]
    r4_itm2: u32,
    #[sqlx(rename = "4thPlaceReward2_Amount")]
    r4_amt2: u32,
    #[sqlx(rename = "5thPlaceReward1_ItmId")]
    r5_itm1: u32,
    #[sqlx(rename = "5thPlaceReward1_Amount")]
    r5_amt1: u32,
    #[sqlx(rename = "5thPlaceReward2_ItmId")]
    r5_itm2: u32,
    #[sqlx(rename = "5thPlaceReward2_Amount")]
    r5_amt2: u32,
}
...
#[derive(sqlx::FromRow)]
struct EventDates {
    #[sqlx(rename = "FromDate")]
    from_date: i32,
    #[sqlx(rename = "FromTime")]
    from_time: i32,
    #[sqlx(rename = "ToDate")]
    to_date: i32,
    #[sqlx(rename = "ToTime")]
...
pub async unsafe fn clif_getReward(pe: &PlayerEntity, fd: SessionId) -> i32 {
    ...
    let g_CURRENT_YEAR = CURRENT_YEAR.load(AtomicOrd::Relaxed);
    let g_CURRENT_SEASON = CURRENT_SEASON.load(AtomicOrd::Relaxed);
    ...
    libc::sprintf(monthyear.as_mut_ptr(), c"Moon %i".as_ptr(), g_CURRENT_YEAR);

    let mut legendicon = 0i32;
    let mut legendiconcolor = 0i32;
    let mut legendicon1 = 0i32;
    let mut legendicon1color = 0i32;
    let mut legendicon2 = 0i32;
    let mut legendicon2color = 0i32;
    let mut legendicon3 = 0i32;
    let mut legendicon3color = 0i32;
    let mut legendicon4 = 0i32;
    let mut legendicon4color = 0i32;
    let mut legendicon5 = 0i32;
    let mut legendicon5color = 0i32;
    let mut reward1amount = 0i32;
    let mut reward2amount = 0i32;
    let mut reward1item = 0i32;
    let mut reward2item = 0i32;
    let mut rewardranks = 0i32;

    let mut _1stPlaceReward1_ItmId = 0i32;
    let mut _1stPlaceReward1_Amount = 0i32;
    let mut _1stPlaceReward2_ItmId = 0i32;
    let mut _1stPlaceReward2_Amount = 0i32;
    let mut _2ndPlaceReward1_ItmId = 0i32;
    let mut _2ndPlaceReward1_Amount = 0i32;
    let mut _2ndPlaceReward2_ItmId = 0i32;
    let mut _2ndPlaceReward2_Amount = 0i32;
    let mut _3rdPlaceReward1_ItmId = 0i32;
    let mut _3rdPlaceReward1_Amount = 0i32;
    let mut _3rdPlaceReward2_ItmId = 0i32;
    let mut _3rdPlaceReward2_Amount = 0i32;
    let mut _4thPlaceReward1_ItmId = 0i32;
    let mut _4thPlaceReward1_Amount = 0i32;
    let mut _4thPlaceReward2_ItmId = 0i32;
    let mut _4thPlaceReward2_Amount = 0i32;
    let mut _5thPlaceReward1_ItmId = 0i32;
    let mut _5thPlaceReward1_Amount = 0i32;
    let mut _5thPlaceReward2_ItmId = 0i32;
    let mut _5thPlaceReward2_Amount = 0i32;
    ...
    if g_CURRENT_SEASON == 1 {
        libc::strcpy(season.as_mut_ptr(), c"Winter".as_ptr());
    }
    if g_CURRENT_SEASON == 2 {
        libc::strcpy(season.as_mut_ptr(), c"Spring".as_ptr());
    }
    if g_CURRENT_SEASON == 3 {
        libc::strcpy(season.as_mut_ptr(), c"Summer".as_ptr());
    }
    if g_CURRENT_SEASON == 4 {
        libc::strcpy(season.as_mut_ptr(), c"Fall".as_ptr());
    }

    if rank == 1 {
        libc::strcpy(rankname.as_mut_ptr(), c"1st".as_ptr());
    }
    if rank == 2 {
        libc::strcpy(rankname.as_mut_ptr(), c"2nd".as_ptr());
    }
    if rank == 3 {
        libc::strcpy(rankname.as_mut_ptr(), c"3rd".as_ptr());
    }
    if rank == 4 {
        libc::strcpy(rankname.as_mut_ptr(), c"4th".as_ptr());
    }
    if rank == 5 {
        libc::strcpy(rankname.as_mut_ptr(), c"5th".as_ptr());
    }
    if rank == 6 {
        libc::strcpy(rankname.as_mut_ptr(), c"6th".as_ptr());
    }

    match rank {
        1 => {
            libc::sprintf(
                legendbuf.as_mut_ptr(),
                c"%s [%s] (Moon %i, %s)".as_ptr(),
                legend.as_ptr(),
                rankname.as_ptr(),
                g_CURRENT_YEAR,
                season.as_ptr(),
    ...
    for i in 0..MAX_LEGENDS {
        ...
        let leg_name1_ptr = if i + 1 < MAX_LEGENDS {
            pe.read().player.legends.legends[i + 1].name.as_ptr()
        } else {
            c"".as_ptr()
        };
        ...
        {
            libc::strcpy(
                pe.write().player.legends.legends[i].text.as_mut_ptr(),
                legendbuf.as_ptr(),
            );
            libc::sprintf(
    ...
    libc::sprintf(topic.as_mut_ptr(), c"%s Prize".as_ptr(), eventname.as_ptr());
    ...
    if reward1amount >= 1 && reward2amount >= 1 {
        ...
        sent_parcel_success +=
            sendRewardParcel(pe, eventid, rank, reward2item, reward2amount).await;
    }
...
(%i) %s, (%i) %s.\n\nPlease continue to play for more great rewards!"
                ...
                pe_name_ptr,
                reward1amount,
                item_db::search(reward1item as u32).name.as_ptr(),
                reward2amount,
                item_db::search(reward2item as u32).name.as_ptr(),
            );
            libc::sprintf(
                msg.as_mut_ptr(),
...
pub async unsafe fn clif_sendRewardInfo(_pe: &PlayerEntity, fd: SessionId) -> i32 {
    ...
    let mut legendicon5color = 0i32;
    let mut reward2amount = 0i32;
    let mut rewardamount = 0i32;
    let mut rewarditm = 0i32;
    let mut reward2itm = 0i32;
    let mut _1stPlaceReward1_ItmId = 0i32;
    let mut _1stPlaceReward1_Amount = 0i32;
    let mut _1stPlaceReward2_ItmId = 0i32;
    let mut _1stPlaceReward2_Amount = 0i32;
    ...
    for i in 0..rewardranks as usize {
        ...
        libc::sprintf(
            buf.as_mut_ptr(),
            c"%s".as_ptr(),
            item_db::search(rewarditm as u32).name.as_ptr(),
        );
        let buf_len = libc::strlen(buf.as_ptr());
        wfifob(fd, pos, buf_len as u8);
        pos += 1;
        ...
        pos += 2;
        clif_intcheck(
            item_db::search(rewarditm as u32).icon - 49152,
            pos as i32,
            fd,
        );
        pos += 1;
        ...
        libc::sprintf(
            buf.as_mut_ptr(),
            c"%s".as_ptr(),
            item_db::search(reward2itm as u32).name.as_ptr(),
        );
        let buf_len = libc::strlen(buf.as_ptr());
        wfifob(fd, pos, buf_len as u8);
        pos += 1;
        ...
        pos += 2;
        clif_intcheck(
            item_db::search(reward2itm as u32).icon - 49152,
            pos as i32,
            fd,
        );
        pos += 1;
...
pub async unsafe fn dateevent_block(pos: i32, eventid: i32, fd: SessionId, pe: &PlayerEntity) {
    ...
    wfifob(
        fd,
        pos as usize + 20,
        checkevent_claim(eventid, fd, pe).await as u8,
    );
}
...
pub async unsafe fn gettotalscores(eventid: i32) -> i32 {
    ...
    sqlx::query_scalar::<_, i64>("SELECT COUNT(*) FROM `RankingScores` WHERE `EventId` = ?")
        .bind(event_id)
        .fetch_one(get_pool())
        .await
        .unwrap_or(0) as i32
...
pub async unsafe fn getevents() -> i32 {
    sqlx::query_scalar::<_, i64>("SELECT COUNT(*) FROM `RankingEvents`")
        .fetch_one(get_pool())
        .await
        .unwrap_or(0) as i32
}
...
pub unsafe fn canusepowerboards(pe: &PlayerEntity) -> i32 {
    ...
    if pc_readglobalreg(
        &mut *pe.write() as *mut MapSessionData,
        c"carnagehost".as_ptr(),
    ) == 0
    {
        return 0;
    }
    let pe_m = pe.read().m;
    if (2001..=2099).contains(&pe_m) {
        return 1;
    }
    0
}
