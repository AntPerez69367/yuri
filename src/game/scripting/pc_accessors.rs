...
use crate::common::player::inventory::{MAX_BANK_SLOTS, MAX_EQUIP, MAX_INVENTORY};
use crate::common::player::legends::MAX_LEGENDS;
use crate::common::player::spells::{MAX_MAGIC_TIMERS, MAX_SPELLS};
...
use crate::game::pc::{MapSessionData, EQ_FACEACCTWO, SFLAG_FULLSTATS, SFLAG_HPMP, SFLAG_XPMONEY};
use crate::game::player::entity::PlayerEntity;
use crate::session::SessionId;

// ─── Read: block_list embedded fields ────────────────────────────────────────

pub fn sl_pc_bl_id(sd: &mut MapSessionData) -> i32 {
    sd.id as i32
}
pub fn sl_pc_bl_m(sd: &mut MapSessionData) -> i32 {
    sd.m as i32
}
pub fn sl_pc_bl_x(sd: &mut MapSessionData) -> i32 {
    sd.x as i32
}
pub fn sl_pc_bl_y(sd: &mut MapSessionData) -> i32 {
    sd.y as i32
}
pub fn sl_pc_bl_type(sd: &mut MapSessionData) -> i32 {
    sd.bl_type as i32
}

// ─── Read: player fields ─────────────────────────────────────────────────────

pub fn sl_pc_status_id(sd: &mut MapSessionData) -> i32 {
    sd.player.identity.id as i32
}
pub fn sl_pc_status_hp(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.hp as i32
}
pub fn sl_pc_status_mp(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.mp as i32
}
pub fn sl_pc_status_level(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.level as i32
}
pub fn sl_pc_status_exp(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.exp as i32
}
pub fn sl_pc_status_expsoldmagic(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.expsold_magic as i32
} // truncates to low 32 bits; matches C
...
pub fn sl_pc_status_expsoldhealth(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.expsold_health as i32
} // truncates to low 32 bits; matches C
pub fn sl_pc_status_expsoldstats(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.expsold_stats as i32
} // truncates to low 32 bits; matches C
pub fn sl_pc_status_class(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.class as i32
}
pub fn sl_pc_status_totem(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.totem as i32
}
pub fn sl_pc_status_tier(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.tier as i32
}
pub fn sl_pc_status_mark(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.mark as i32
}
pub fn sl_pc_status_country(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.country as i32
}
pub fn sl_pc_status_clan(sd: &mut MapSessionData) -> i32 {
    sd.player.social.clan as i32
}
pub fn sl_pc_status_gm_level(sd: &mut MapSessionData) -> i32 {
    sd.player.identity.gm_level as i32
}
pub fn sl_pc_status_sex(sd: &mut MapSessionData) -> i32 {
    sd.player.identity.sex as i32
}
pub fn sl_pc_status_side(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.side as i32
}
pub fn sl_pc_status_state(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.state as i32
}
pub fn sl_pc_status_face(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.face as i32
}
pub fn sl_pc_status_hair(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.hair as i32
}
pub fn sl_pc_status_hair_color(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.hair_color as i32
}
pub fn sl_pc_status_face_color(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.face_color as i32
}
pub fn sl_pc_status_armor_color(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.armor_color as i32
}
pub fn sl_pc_status_skin_color(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.skin_color as i32
}
pub fn sl_pc_status_basehp(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.max_hp as i32
}
pub fn sl_pc_status_basemp(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.max_mp as i32
}
pub fn sl_pc_status_money(sd: &mut MapSessionData) -> i32 {
    sd.player.inventory.money as i32
}
pub fn sl_pc_status_bankmoney(sd: &mut MapSessionData) -> i32 {
    sd.player.inventory.bank_money as i32
}
pub fn sl_pc_status_maxslots(sd: &mut MapSessionData) -> i32 {
    sd.player.inventory.max_slots as i32
}
pub fn sl_pc_status_maxinv(sd: &mut MapSessionData) -> i32 {
    sd.player.inventory.max_inv as i32
}
pub fn sl_pc_status_partner(sd: &mut MapSessionData) -> i32 {
    sd.player.social.partner as i32
}
pub fn sl_pc_status_pk(sd: &mut MapSessionData) -> i32 {
    sd.player.social.pk as i32
}
pub fn sl_pc_status_killedby(sd: &mut MapSessionData) -> i32 {
    sd.player.social.killed_by as i32
}
pub fn sl_pc_status_killspk(sd: &mut MapSessionData) -> i32 {
    sd.player.social.kills_pk as i32
}
pub fn sl_pc_status_pkduration(sd: &mut MapSessionData) -> i32 {
    sd.player.social.pk_duration as i32
}
pub fn sl_pc_status_basegrace(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.base_grace as i32
}
pub fn sl_pc_status_basemight(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.base_might as i32
}
pub fn sl_pc_status_basewill(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.base_will as i32
}
pub fn sl_pc_status_basearmor(sd: &mut MapSessionData) -> i32 {
    sd.player.combat.base_armor
}
pub fn sl_pc_status_tutor(sd: &mut MapSessionData) -> i32 {
    sd.player.social.tutor as i32
}
pub fn sl_pc_status_karma(sd: &mut MapSessionData) -> i32 {
    sd.player.social.karma as i32
} // truncates float to int; matches C
pub fn sl_pc_status_alignment(sd: &mut MapSessionData) -> i32 {
    sd.player.social.alignment as i32
}
pub fn sl_pc_status_classRank(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.class_rank
}
pub fn sl_pc_status_clanRank(sd: &mut MapSessionData) -> i32 {
    sd.player.progression.clan_rank
}
pub fn sl_pc_status_novice_chat(sd: &mut MapSessionData) -> i32 {
    sd.player.social.novice_chat as i32
}
pub fn sl_pc_status_subpath_chat(sd: &mut MapSessionData) -> i32 {
    sd.player.social.subpath_chat as i32
}
pub fn sl_pc_status_clan_chat(sd: &mut MapSessionData) -> i32 {
    sd.player.social.clan_chat as i32
}
pub fn sl_pc_status_miniMapToggle(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.mini_map_toggle as i32
}
pub fn sl_pc_status_heroes(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.heroes as i32
}
pub fn sl_pc_status_mute(sd: &mut MapSessionData) -> i32 {
    sd.player.social.mute as i32
}
pub fn sl_pc_status_settingFlags(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.setting_flags as i32
}
// sl_pc_status_killspvp reads from the direct USER field `killspvp`, not player.
pub fn sl_pc_status_killspvp(sd: &mut MapSessionData) -> i32 {
    sd.killspvp as i32
}
pub fn sl_pc_status_profile_vitastats(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.profile_vitastats as i32
}
pub fn sl_pc_status_profile_equiplist(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.profile_equiplist as i32
}
pub fn sl_pc_status_profile_legends(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.profile_legends as i32
}
pub fn sl_pc_status_profile_spells(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.profile_spells as i32
}
pub fn sl_pc_status_profile_inventory(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.profile_inventory as i32
}
pub fn sl_pc_status_profile_bankitems(sd: &mut MapSessionData) -> i32 {
    sd.player.appearance.profile_bankitems as i32
}
...
pub fn sl_pc_npc_g(sd: &mut MapSessionData) -> i32 {
    sd.npc_g
}
pub fn sl_pc_npc_gc(sd: &mut MapSessionData) -> i32 {
    sd.npc_gc
}
pub fn sl_pc_groupid(sd: &mut MapSessionData) -> i32 {
    sd.groupid as i32
}
pub fn sl_pc_time(sd: &mut MapSessionData) -> i32 {
    sd.time
}
pub fn sl_pc_fakeDrop(sd: &mut MapSessionData) -> i32 {
    sd.fakeDrop as i32
}
pub fn sl_pc_max_hp(sd: &mut MapSessionData) -> i32 {
    sd.max_hp as i32
}
pub fn sl_pc_max_mp(sd: &mut MapSessionData) -> i32 {
    sd.max_mp as i32
}
pub fn sl_pc_lastvita(sd: &mut MapSessionData) -> i32 {
    sd.lastvita as i32
}
pub fn sl_pc_rage(sd: &mut MapSessionData) -> i32 {
    sd.rage as i32
} // truncates float to int; matches C
pub fn sl_pc_polearm(sd: &mut MapSessionData) -> i32 {
    sd.polearm
}
pub fn sl_pc_last_click(sd: &mut MapSessionData) -> i32 {
    sd.last_click as i32
}
pub fn sl_pc_grace(sd: &mut MapSessionData) -> i32 {
    sd.grace
}
pub fn sl_pc_might(sd: &mut MapSessionData) -> i32 {
    sd.might
}
pub fn sl_pc_will(sd: &mut MapSessionData) -> i32 {
    sd.will
}
pub fn sl_pc_armor(sd: &mut MapSessionData) -> i32 {
    sd.armor
}
pub fn sl_pc_dam(sd: &mut MapSessionData) -> i32 {
    sd.dam
}
pub fn sl_pc_hit(sd: &mut MapSessionData) -> i32 {
    sd.hit
}
pub fn sl_pc_miss(sd: &mut MapSessionData) -> i32 {
    sd.miss as i32
}
pub fn sl_pc_sleep(sd: &mut MapSessionData) -> i32 {
    sd.sleep as i32
} // truncates float to int; matches C
pub fn sl_pc_set_sleep(sd: &mut MapSessionData, v: i32) {
    sd.sleep = v as f32;
}
pub fn sl_pc_attack_speed(sd: &mut MapSessionData) -> i32 {
    sd.attack_speed as i32
}
pub fn sl_pc_enchanted(sd: &mut MapSessionData) -> i32 {
    sd.enchanted as i32
} // truncates float to int; matches C
pub fn sl_pc_confused(sd: &mut MapSessionData) -> i32 {
    sd.confused as i32
}
pub fn sl_pc_target(sd: &mut MapSessionData) -> i32 {
    sd.target
}
pub fn sl_pc_set_target(sd: &mut MapSessionData, v: i32) {
    sd.target = v;
}
pub fn sl_pc_deduction(sd: &mut MapSessionData) -> i32 {
    sd.deduction as i32
} // truncates float to int; matches C
pub fn sl_pc_speed(sd: &mut MapSessionData) -> i32 {
    sd.speed
}
pub fn sl_pc_disguise(sd: &mut MapSessionData) -> i32 {
    sd.disguise as i32
}
pub fn sl_pc_disguise_color(sd: &mut MapSessionData) -> i32 {
    sd.disguise_color as i32
}
pub fn sl_pc_attacker(sd: &mut MapSessionData) -> i32 {
    sd.attacker as i32
}
pub fn sl_pc_invis(sd: &mut MapSessionData) -> i32 {
    sd.invis as i32
} // truncates float to int; matches C
pub fn sl_pc_damage(sd: &mut MapSessionData) -> i32 {
    sd.damage as i32
} // truncates float to int; matches C
pub fn sl_pc_crit(sd: &mut MapSessionData) -> i32 {
    sd.crit
}
pub fn sl_pc_critchance(sd: &mut MapSessionData) -> i32 {
    sd.critchance
}
pub fn sl_pc_critmult(sd: &mut MapSessionData) -> i32 {
    sd.critmult as i32
} // truncates float to int; matches C
pub fn sl_pc_rangeTarget(sd: &mut MapSessionData) -> i32 {
    sd.rangeTarget as i32
}
pub fn sl_pc_exchange_gold(sd: &mut MapSessionData) -> i32 {
    sd.exchange.gold as i32
}
pub fn sl_pc_exchange_count(sd: &mut MapSessionData) -> i32 {
    sd.exchange.item_count
}
pub fn sl_pc_bod_count(sd: &mut MapSessionData) -> i32 {
    sd.boditems.bod_count
}
pub fn sl_pc_paralyzed(sd: &mut MapSessionData) -> i32 {
    sd.paralyzed
}
pub fn sl_pc_blind(sd: &mut MapSessionData) -> i32 {
    sd.blind
}
pub fn sl_pc_drunk(sd: &mut MapSessionData) -> i32 {
    sd.drunk
}
pub fn sl_pc_board(sd: &mut MapSessionData) -> i32 {
    sd.board
}
pub fn sl_pc_board_candel(sd: &mut MapSessionData) -> i32 {
    sd.board_candel
}
pub fn sl_pc_board_canwrite(sd: &mut MapSessionData) -> i32 {
    sd.board_canwrite
}
pub fn sl_pc_boardshow(sd: &mut MapSessionData) -> i32 {
    sd.boardshow as i32
}
pub fn sl_pc_boardnameval(sd: &mut MapSessionData) -> i32 {
    sd.boardnameval as i32
}
pub fn sl_pc_msPing(sd: &mut MapSessionData) -> i32 {
    sd.msPing
}
pub fn sl_pc_pbColor(sd: &mut MapSessionData) -> i32 {
    sd.pbColor
}
pub fn sl_pc_coref(sd: &mut MapSessionData) -> i32 {
    sd.coref as i32
}
pub fn sl_pc_optFlags(sd: &mut MapSessionData) -> i32 {
    sd.optFlags as i32
} // u64 (64-bit); truncates to low 32 bits; matches C
pub fn sl_pc_snare(sd: &mut MapSessionData) -> i32 {
    sd.snare
}
pub fn sl_pc_silence(sd: &mut MapSessionData) -> i32 {
    sd.silence
}
pub fn sl_pc_extendhit(sd: &mut MapSessionData) -> i32 {
    sd.extendhit
}
pub fn sl_pc_afk(sd: &mut MapSessionData) -> i32 {
    sd.afk
}
pub fn sl_pc_afktime(sd: &mut MapSessionData) -> i32 {
    sd.afktime
}
pub fn sl_pc_totalafktime(sd: &mut MapSessionData) -> i32 {
    sd.totalafktime
}
pub fn sl_pc_backstab(sd: &mut MapSessionData) -> i32 {
    sd.backstab
}
pub fn sl_pc_flank(sd: &mut MapSessionData) -> i32 {
    sd.flank
}
pub fn sl_pc_healing(sd: &mut MapSessionData) -> i32 {
    sd.healing
}
pub fn sl_pc_minSdam(sd: &mut MapSessionData) -> i32 {
    sd.minSdam
}
pub fn sl_pc_maxSdam(sd: &mut MapSessionData) -> i32 {
    sd.maxSdam
}
pub fn sl_pc_minLdam(sd: &mut MapSessionData) -> i32 {
    sd.minLdam
}
pub fn sl_pc_maxLdam(sd: &mut MapSessionData) -> i32 {
    sd.maxLdam
}
pub fn sl_pc_talktype(sd: &mut MapSessionData) -> i32 {
    sd.talktype as i32
}
pub fn sl_pc_equipid(sd: &mut MapSessionData) -> i32 {
    sd.equipid as i32
}
pub fn sl_pc_takeoffid(sd: &mut MapSessionData) -> i32 {
    sd.takeoffid as i32
}
pub fn sl_pc_breakid(sd: &mut MapSessionData) -> i32 {
    sd.breakid as i32
}
pub fn sl_pc_equipslot(sd: &mut MapSessionData) -> i32 {
    sd.equipslot as i32
}
pub fn sl_pc_invslot(sd: &mut MapSessionData) -> i32 {
    sd.invslot as i32
}
pub fn sl_pc_pickuptype(sd: &mut MapSessionData) -> i32 {
    sd.pickuptype as i32
}
pub fn sl_pc_spottraps(sd: &mut MapSessionData) -> i32 {
    sd.spottraps as i32
}
pub fn sl_pc_fury(sd: &mut MapSessionData) -> i32 {
    sd.fury as i32
} // truncates float to int; matches C
...
pub fn sl_pc_protection(sd: &mut MapSessionData) -> i32 {
    sd.protection as i32
}
pub fn sl_pc_clone(sd: &mut MapSessionData) -> i32 {
    sd.clone as i32
}
pub fn sl_pc_wisdom(sd: &mut MapSessionData) -> i32 {
    sd.wisdom
}
pub fn sl_pc_con(sd: &mut MapSessionData) -> i32 {
    sd.con as i32
}
pub fn sl_pc_deathflag(sd: &mut MapSessionData) -> i32 {
    sd.deathflag as i32
}
pub fn sl_pc_selfbar(sd: &mut MapSessionData) -> i32 {
    sd.selfbar as i32
}
pub fn sl_pc_groupbars(sd: &mut MapSessionData) -> i32 {
    sd.groupbars as i32
}
pub fn sl_pc_mobbars(sd: &mut MapSessionData) -> i32 {
    sd.mobbars as i32
}
pub fn sl_pc_disptimertick(sd: &mut MapSessionData) -> i32 {
    sd.disptimertick as i32
}
pub fn sl_pc_bindmap(sd: &mut MapSessionData) -> i32 {
    sd.bindmap as i32
}
pub fn sl_pc_bindx(sd: &mut MapSessionData) -> i32 {
    sd.bindx
}
pub fn sl_pc_bindy(sd: &mut MapSessionData) -> i32 {
    sd.bindy
}
pub fn sl_pc_ambushtimer(sd: &mut MapSessionData) -> i32 {
    sd.ambushtimer as i32
} // u64 (64-bit); truncates to low 32 bits; matches C
pub fn sl_pc_dialogtype(sd: &mut MapSessionData) -> i32 {
    sd.dialogtype as i32
}
pub fn sl_pc_set_dialogtype(sd: &mut MapSessionData, v: i32) {
    sd.dialogtype = v as i8;
}
pub fn sl_pc_cursed(sd: &mut MapSessionData) -> i32 {
    sd.cursed as i32
}
pub fn sl_pc_action(sd: &mut MapSessionData) -> i32 {
    sd.action as i32
}
pub fn sl_pc_scripttick(sd: &mut MapSessionData) -> i32 {
    sd.scripttick
}
pub fn sl_pc_dmgshield(sd: &mut MapSessionData) -> i32 {
    sd.dmgshield as i32
} // truncates float to int; matches C
pub fn sl_pc_dmgdealt(sd: &mut MapSessionData) -> i32 {
    sd.dmgdealt as i32
} // truncates float to int; matches C
pub fn sl_pc_dmgtaken(sd: &mut MapSessionData) -> i32 {
    sd.dmgtaken as i32
} // truncates float to int; matches C
...
pub fn sl_pc_gfx_face(sd: &mut MapSessionData) -> i32 {
    sd.gfx.face as i32
}
pub fn sl_pc_gfx_hair(sd: &mut MapSessionData) -> i32 {
    sd.gfx.hair as i32
}
pub fn sl_pc_gfx_chair(sd: &mut MapSessionData) -> i32 {
    sd.gfx.chair as i32
}
pub fn sl_pc_gfx_cface(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cface as i32
}
pub fn sl_pc_gfx_cskin(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cskin as i32
}
pub fn sl_pc_gfx_dye(sd: &mut MapSessionData) -> i32 {
    sd.gfx.dye as i32
}
pub fn sl_pc_gfx_weapon(sd: &mut MapSessionData) -> i32 {
    sd.gfx.weapon as i32
}
pub fn sl_pc_gfx_cweapon(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cweapon as i32
}
pub fn sl_pc_gfx_armor(sd: &mut MapSessionData) -> i32 {
    sd.gfx.armor as i32
}
pub fn sl_pc_gfx_carmor(sd: &mut MapSessionData) -> i32 {
    sd.gfx.carmor as i32
}
pub fn sl_pc_gfx_shield(sd: &mut MapSessionData) -> i32 {
    sd.gfx.shield as i32
}
pub fn sl_pc_gfx_cshield(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cshield as i32
}
pub fn sl_pc_gfx_helm(sd: &mut MapSessionData) -> i32 {
    sd.gfx.helm as i32
}
pub fn sl_pc_gfx_chelm(sd: &mut MapSessionData) -> i32 {
    sd.gfx.chelm as i32
}
pub fn sl_pc_gfx_mantle(sd: &mut MapSessionData) -> i32 {
    sd.gfx.mantle as i32
}
pub fn sl_pc_gfx_cmantle(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cmantle as i32
}
pub fn sl_pc_gfx_crown(sd: &mut MapSessionData) -> i32 {
    sd.gfx.crown as i32
}
pub fn sl_pc_gfx_ccrown(sd: &mut MapSessionData) -> i32 {
    sd.gfx.ccrown as i32
}
pub fn sl_pc_gfx_faceAcc(sd: &mut MapSessionData) -> i32 {
    sd.gfx.face_acc as i32
}
pub fn sl_pc_gfx_cfaceAcc(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cface_acc as i32
}
pub fn sl_pc_gfx_faceAccT(sd: &mut MapSessionData) -> i32 {
    sd.gfx.face_acc_t as i32
}
pub fn sl_pc_gfx_cfaceAccT(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cface_acc_t as i32
}
pub fn sl_pc_gfx_boots(sd: &mut MapSessionData) -> i32 {
    sd.gfx.boots as i32
}
pub fn sl_pc_gfx_cboots(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cboots as i32
}
pub fn sl_pc_gfx_necklace(sd: &mut MapSessionData) -> i32 {
    sd.gfx.necklace as i32
}
pub fn sl_pc_gfx_cnecklace(sd: &mut MapSessionData) -> i32 {
    sd.gfx.cnecklace as i32
}
...
use crate::game::map_parse::combat::{
    clif_deductarmor, clif_deductdura, clif_deductduraequip, clif_deductweapon, clif_mob_damage,
    clif_parseattack, clif_pc_damage, clif_send_aether, clif_send_duration, clif_send_pc_health,
    clif_send_pc_healthscript,
};
use crate::game::map_parse::dialogs::clif_send_timer;
use crate::game::map_parse::items::{clif_checkinvbod, clif_sendadditem, clif_throwitem_script};
use crate::game::map_parse::movement::{clif_blockmovement, clif_noparsewalk, clif_refreshnoclick};
use crate::game::map_parse::player_state::{clif_sendminimap, clif_sendstatus, clif_sendxychange};
use crate::game::map_server::{boards_readpost, boards_showposts, map_id2sd_pc, nmail_sendmail};
use crate::game::pc::{
    pc_additem as pc_additem_acc, pc_calcstat, pc_checklevel, pc_delitem, pc_diescript,
    pc_dropitemmap, pc_equipscript, pc_getitemscript, pc_isinvenspace, pc_loaditem, pc_loadmagic,
    pc_requestmp, pc_res, pc_setpos, pc_unequipscript, pc_warp, ItemCustomization,
};
use crate::game::scripting::sl_async_freeco;
// map lookups — use typed versions
use crate::database::{clan_db, class_db, magic_db};
...
use crate::game::client::handlers::{
    clif_getaccountemail_sync as clif_getaccountemail, clif_isregistered_sync as clif_isregistered,
};
...
pub fn sl_pc_classNameMark(sd: &mut MapSessionData) -> *const i8 {
    string_to_cptr(classdb_name_ffi(
        sd.player.progression.class as i32,
        sd.player.progression.mark as i32,
    ))
}
...
// player.* setters
pub fn sl_pc_set_hp(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.hp = v as u32;
}
pub fn sl_pc_set_mp(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.mp = v as u32;
}
...
pub fn sl_pc_set_totem(sd: &mut MapSessionData, v: i32) {
    sd.player.progression.totem = v as u8;
}
pub fn sl_pc_set_tier(sd: &mut MapSessionData, v: i32) {
    sd.player.progression.tier = v as u8;
}
pub fn sl_pc_set_mark(sd: &mut MapSessionData, v: i32) {
    sd.player.progression.mark = v as u8;
}
pub fn sl_pc_set_country(sd: &mut MapSessionData, v: i32) {
    sd.player.progression.country = v as i8;
}
pub fn sl_pc_set_clan(sd: &mut MapSessionData, v: i32) {
    sd.player.social.clan = v as u32;
}
pub fn sl_pc_set_gm_level(sd: &mut MapSessionData, v: i32) {
    sd.player.identity.gm_level = v as i8;
}
pub fn sl_pc_set_side(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.side = v as i8;
}
pub fn sl_pc_set_state(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.state = v as i8;
}
pub fn sl_pc_set_hair(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.hair = v as u16;
}
pub fn sl_pc_set_hair_color(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.hair_color = v as u16;
}
pub fn sl_pc_set_face_color(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.face_color = v as u16;
}
pub fn sl_pc_set_armor_color(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.armor_color = v as u16;
}
pub fn sl_pc_set_skin_color(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.skin_color = v as u16;
}
pub fn sl_pc_set_face(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.face = v as u16;
}
pub fn sl_pc_set_money(sd: &mut MapSessionData, v: i32) {
    sd.player.inventory.money = v as u32;
}
pub fn sl_pc_set_bankmoney(sd: &mut MapSessionData, v: i32) {
    sd.player.inventory.bank_money = v as u32;
}
pub fn sl_pc_set_maxslots(sd: &mut MapSessionData, v: i32) {
    sd.player.inventory.max_slots = v as u32;
}
pub fn sl_pc_set_maxinv(sd: &mut MapSessionData, v: i32) {
    sd.player.inventory.max_inv = v as u8;
}
pub fn sl_pc_set_partner(sd: &mut MapSessionData, v: i32) {
    sd.player.social.partner = v as u32;
}
pub fn sl_pc_set_pk(sd: &mut MapSessionData, v: i32) {
    sd.player.social.pk = v as u8;
}
pub fn sl_pc_set_basehp(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.max_hp = v as u32;
}
pub fn sl_pc_set_basemp(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.max_mp = v as u32;
}
pub fn sl_pc_set_karma(sd: &mut MapSessionData, v: i32) {
    sd.player.social.karma = v as f32;
}
pub fn sl_pc_set_alignment(sd: &mut MapSessionData, v: i32) {
    sd.player.social.alignment = v as i8;
}
pub fn sl_pc_set_basegrace(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.base_grace = v as u32;
}
pub fn sl_pc_set_basemight(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.base_might = v as u32;
}
pub fn sl_pc_set_basewill(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.base_will = v as u32;
}
pub fn sl_pc_set_basearmor(sd: &mut MapSessionData, v: i32) {
    sd.player.combat.base_armor = v;
}
pub fn sl_pc_set_novice_chat(sd: &mut MapSessionData, v: i32) {
    sd.player.social.novice_chat = v as i8;
}
pub fn sl_pc_set_subpath_chat(sd: &mut MapSessionData, v: i32) {
    sd.player.social.subpath_chat = v as i8;
}
pub fn sl_pc_set_clan_chat(sd: &mut MapSessionData, v: i32) {
    sd.player.social.clan_chat = v as i8;
}
pub fn sl_pc_set_tutor(sd: &mut MapSessionData, v: i32) {
    sd.player.social.tutor = v as u8;
}
pub fn sl_pc_set_profile_vitastats(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.profile_vitastats = v as u8;
}
pub fn sl_pc_set_profile_equiplist(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.profile_equiplist = v as u8;
}
pub fn sl_pc_set_profile_legends(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.profile_legends = v as u8;
}
pub fn sl_pc_set_profile_spells(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.profile_spells = v as u8;
}
pub fn sl_pc_set_profile_inventory(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.profile_inventory = v as u8;
}
pub fn sl_pc_set_profile_bankitems(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.profile_bankitems = v as u8;
}
pub fn sl_pc_set_mute(sd: &mut MapSessionData, v: i32) {
    sd.player.social.mute = v as i8;
}
pub fn sl_pc_set_settingFlags(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.setting_flags = v as u32;
}
pub fn sl_pc_set_heroshow(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.heroes = v as u32;
}
pub fn sl_pc_set_sex(sd: &mut MapSessionData, v: i32) {
    sd.player.identity.sex = v as i8;
}
pub fn sl_pc_set_classRank(sd: &mut MapSessionData, v: i32) {
    sd.player.progression.class_rank = v;
}
pub fn sl_pc_set_clanRank(sd: &mut MapSessionData, v: i32) {
    sd.player.progression.clan_rank = v;
}
pub fn sl_pc_setminimaptoggle(sd: &mut MapSessionData, v: i32) {
    sd.player.appearance.mini_map_toggle = v as u32;
}

// direct USER field setters
pub fn sl_pc_set_max_hp(sd: &mut MapSessionData, v: i32) {
    sd.max_hp = v as u32;
}
pub fn sl_pc_set_max_mp(sd: &mut MapSessionData, v: i32) {
    sd.max_mp = v as u32;
}
pub fn sl_pc_set_npc_g(sd: &mut MapSessionData, v: i32) {
    sd.npc_g = v;
}
pub fn sl_pc_set_npc_gc(sd: &mut MapSessionData, v: i32) {
    sd.npc_gc = v;
}
pub fn sl_pc_set_last_click(sd: &mut MapSessionData, v: i32) {
    sd.last_click = v as u32;
}
pub fn sl_pc_set_time(sd: &mut MapSessionData, v: i32) {
    sd.time = v;
}
pub fn sl_pc_set_rage(sd: &mut MapSessionData, v: i32) {
    sd.rage = v as f32;
}
pub fn sl_pc_set_polearm(sd: &mut MapSessionData, v: i32) {
    sd.polearm = v;
}
pub fn sl_pc_set_deduction(sd: &mut MapSessionData, v: i32) {
    sd.deduction = v as f32;
}
pub fn sl_pc_set_speed(sd: &mut MapSessionData, v: i32) {
    sd.speed = v;
}
pub fn sl_pc_set_attacker(sd: &mut MapSessionData, v: i32) {
    sd.attacker = v as u32;
}
pub fn sl_pc_set_invis(sd: &mut MapSessionData, v: i32) {
    sd.invis = v as f32;
}
pub fn sl_pc_set_damage(sd: &mut MapSessionData, v: i32) {
    sd.damage = v as f32;
}
pub fn sl_pc_set_crit(sd: &mut MapSessionData, v: i32) {
    sd.crit = v;
}
pub fn sl_pc_set_critchance(sd: &mut MapSessionData, v: i32) {
    sd.critchance = v;
}
pub fn sl_pc_set_critmult(sd: &mut MapSessionData, v: i32) {
    sd.critmult = v as f32;
}
pub fn sl_pc_set_rangeTarget(sd: &mut MapSessionData, v: i32) {
    sd.rangeTarget = v as u32;
}
pub fn sl_pc_set_disguise(sd: &mut MapSessionData, v: i32) {
    sd.disguise = v as u16;
}
pub fn sl_pc_set_disguise_color(sd: &mut MapSessionData, v: i32) {
    sd.disguise_color = v as u16;
}
pub fn sl_pc_set_paralyzed(sd: &mut MapSessionData, v: i32) {
    sd.paralyzed = v;
}
pub fn sl_pc_set_blind(sd: &mut MapSessionData, v: i32) {
    sd.blind = v;
}
pub fn sl_pc_set_drunk(sd: &mut MapSessionData, v: i32) {
    sd.drunk = v;
}
pub fn sl_pc_set_board_candel(sd: &mut MapSessionData, v: i32) {
    sd.board_candel = v;
}
pub fn sl_pc_set_board_canwrite(sd: &mut MapSessionData, v: i32) {
    sd.board_canwrite = v;
}
pub fn sl_pc_set_boardshow(sd: &mut MapSessionData, v: i32) {
    sd.boardshow = v as i8;
}
pub fn sl_pc_set_boardnameval(sd: &mut MapSessionData, v: i32) {
    sd.boardnameval = v as i8;
}
pub fn sl_pc_set_snare(sd: &mut MapSessionData, v: i32) {
    sd.snare = v;
}
pub fn sl_pc_set_silence(sd: &mut MapSessionData, v: i32) {
    sd.silence = v;
}
pub fn sl_pc_set_extendhit(sd: &mut MapSessionData, v: i32) {
    sd.extendhit = v;
}
pub fn sl_pc_set_afk(sd: &mut MapSessionData, v: i32) {
    sd.afk = v;
}
pub fn sl_pc_set_confused(sd: &mut MapSessionData, v: i32) {
    sd.confused = v as u8;
}
pub fn sl_pc_set_spottraps(sd: &mut MapSessionData, v: i32) {
    sd.spottraps = v as u8;
}
pub fn sl_pc_set_selfbar(sd: &mut MapSessionData, v: i32) {
    sd.selfbar = v as i8;
}
pub fn sl_pc_set_groupbars(sd: &mut MapSessionData, v: i32) {
    sd.groupbars = v as i8;
}
pub fn sl_pc_set_mobbars(sd: &mut MapSessionData, v: i32) {
    sd.mobbars = v as i8;
}
// C uses (unsigned int) for the XOR mask but uFlags is u64; XOR low 32 bits, upper preserved.
pub fn sl_pc_set_optFlags_xor(sd: &mut MapSessionData, v: i32) {
    sd.optFlags ^= v as u32 as u64;
}
pub fn sl_pc_set_uflags_xor(sd: &mut MapSessionData, v: i32) {
    sd.uFlags ^= v as u32 as u64;
}
pub fn sl_pc_set_talktype(sd: &mut MapSessionData, v: i32) {
    sd.talktype = v as u8;
}
pub fn sl_pc_set_cursed(sd: &mut MapSessionData, v: i32) {
    sd.cursed = v as u8;
}
pub fn sl_pc_set_deathflag(sd: &mut MapSessionData, v: i32) {
    sd.deathflag = v as i8;
}
pub fn sl_pc_set_bindmap(sd: &mut MapSessionData, v: i32) {
    sd.bindmap = v as u16;
}
pub fn sl_pc_set_bindx(sd: &mut MapSessionData, v: i32) {
    sd.bindx = v;
}
pub fn sl_pc_set_bindy(sd: &mut MapSessionData, v: i32) {
    sd.bindy = v;
}
pub fn sl_pc_set_protection(sd: &mut MapSessionData, v: i32) {
    sd.protection = v as i16;
}
pub fn sl_pc_set_dmgshield(sd: &mut MapSessionData, v: i32) {
    sd.dmgshield = v as f32;
}
pub fn sl_pc_set_dmgdealt(sd: &mut MapSessionData, v: i32) {
    sd.dmgdealt = v as f64;
}
pub fn sl_pc_set_dmgtaken(sd: &mut MapSessionData, v: i32) {
    sd.dmgtaken = v as f64;
}
pub fn sl_pc_set_fakeDrop(sd: &mut MapSessionData, v: i32) {
    sd.fakeDrop = v as u8;
}
pub fn sl_pc_set_clone(sd: &mut MapSessionData, v: i32) {
    sd.clone = v as i8;
}
pub fn sl_pc_set_fury(sd: &mut MapSessionData, v: i32) {
    sd.fury = v as f32;
}
pub fn sl_pc_set_coref_container(sd: &mut MapSessionData, v: i32) {
    sd.coref_container = v as u32;
}
pub fn sl_pc_set_wisdom(sd: &mut MapSessionData, v: i32) {
    sd.wisdom = v;
}
pub fn sl_pc_set_con(sd: &mut MapSessionData, v: i32) {
    sd.con = v as i16;
}
pub fn sl_pc_set_backstab(sd: &mut MapSessionData, v: i32) {
    sd.backstab = v;
}
pub fn sl_pc_set_flank(sd: &mut MapSessionData, v: i32) {
    sd.flank = v;
}
pub fn sl_pc_set_healing(sd: &mut MapSessionData, v: i32) {
    sd.healing = v;
}
pub fn sl_pc_set_pbColor(sd: &mut MapSessionData, v: i32) {
    sd.pbColor = v;
}
...
pub fn sl_pc_set_gfx_face(sd: &mut MapSessionData, v: i32) {
    sd.gfx.face = v as u8;
}
pub fn sl_pc_set_gfx_hair(sd: &mut MapSessionData, v: i32) {
    sd.gfx.hair = v as u8;
}
pub fn sl_pc_set_gfx_chair(sd: &mut MapSessionData, v: i32) {
    sd.gfx.chair = v as u8;
}
pub fn sl_pc_set_gfx_cface(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cface = v as u8;
}
pub fn sl_pc_set_gfx_cskin(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cskin = v as u8;
}
pub fn sl_pc_set_gfx_dye(sd: &mut MapSessionData, v: i32) {
    sd.gfx.dye = v as u8;
}
pub fn sl_pc_set_gfx_weapon(sd: &mut MapSessionData, v: i32) {
    sd.gfx.weapon = v as u16;
}
pub fn sl_pc_set_gfx_cweapon(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cweapon = v as u8;
}
pub fn sl_pc_set_gfx_armor(sd: &mut MapSessionData, v: i32) {
    sd.gfx.armor = v as u16;
}
pub fn sl_pc_set_gfx_carmor(sd: &mut MapSessionData, v: i32) {
    sd.gfx.carmor = v as u8;
}
pub fn sl_pc_set_gfx_shield(sd: &mut MapSessionData, v: i32) {
    sd.gfx.shield = v as u16;
}
pub fn sl_pc_set_gfx_cshield(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cshield = v as u8;
}
pub fn sl_pc_set_gfx_helm(sd: &mut MapSessionData, v: i32) {
    sd.gfx.helm = v as u16;
}
pub fn sl_pc_set_gfx_chelm(sd: &mut MapSessionData, v: i32) {
    sd.gfx.chelm = v as u8;
}
pub fn sl_pc_set_gfx_mantle(sd: &mut MapSessionData, v: i32) {
    sd.gfx.mantle = v as u16;
}
pub fn sl_pc_set_gfx_cmantle(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cmantle = v as u8;
}
pub fn sl_pc_set_gfx_crown(sd: &mut MapSessionData, v: i32) {
    sd.gfx.crown = v as u16;
}
pub fn sl_pc_set_gfx_ccrown(sd: &mut MapSessionData, v: i32) {
    sd.gfx.ccrown = v as u8;
}
pub fn sl_pc_set_gfx_faceAcc(sd: &mut MapSessionData, v: i32) {
    sd.gfx.face_acc = v as u16;
}
pub fn sl_pc_set_gfx_cfaceAcc(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cface_acc = v as u8;
}
pub fn sl_pc_set_gfx_faceAccT(sd: &mut MapSessionData, v: i32) {
    sd.gfx.face_acc_t = v as u16;
}
pub fn sl_pc_set_gfx_cfaceAccT(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cface_acc_t = v as u8;
}
pub fn sl_pc_set_gfx_boots(sd: &mut MapSessionData, v: i32) {
    sd.gfx.boots = v as u16;
}
pub fn sl_pc_set_gfx_cboots(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cboots = v as u8;
}
pub fn sl_pc_set_gfx_necklace(sd: &mut MapSessionData, v: i32) {
    sd.gfx.necklace = v as u16;
}
pub fn sl_pc_set_gfx_cnecklace(sd: &mut MapSessionData, v: i32) {
    sd.gfx.cnecklace = v as u8;
}
...
pub fn sl_pc_hasequipped(sd: &mut MapSessionData, item_id: u32) -> i32 {
    for i in 0..MAX_EQUIP {
        if sd.player.inventory.equip[i].id == item_id {
            return 1;
        }
    }
    0
...
pub unsafe fn sl_pc_removeitemslot(sd: &mut MapSessionData, slot: i32, amount: i32, kind: i32) {
    if let Some(arc) = map_id2sd_pc(sd.id) {
        pc_delitem(&arc, slot, amount, kind);
    }
}
...
pub fn sl_pc_setkillcount(sd: &mut MapSessionData, mob_id: i32, amount: i32) {
    if amount > 0 {
        sd.player
            .registries
            .kill_reg
            .insert(mob_id as u32, amount as u32);
    } else {
...
pub unsafe fn sl_pc_addthreat(sd: &mut MapSessionData, mob_id: u32, amount: u32) {
    ...
    for x in 0..MAX_THREATCOUNT {
        if (*mob).threat[x].user == uid {
            (*mob).threat[x].amount += amount;
            return;
        }
        if (*mob).threat[x].user == 0 {
            (*mob).threat[x].user = uid;
            (*mob).threat[x].amount = amount;
            return;
        }
    }
...
pub unsafe fn sl_pc_hasspell(sd: &mut MapSessionData, name: *const i8) -> i32 {
    ...
    for i in 0..MAX_SPELLS {
        if sd.player.spells.skills[i] == id as u16 {
            return 1;
        }
    }
    0
...
pub fn sl_pc_removespell(sd: &mut MapSessionData, spell_id: i32) {
    for i in 0..MAX_SPELLS {
        if sd.player.spells.skills[i] == spell_id as u16 {
            sd.player.spells.skills[i] = 0;
        }
    }
}
...
pub unsafe fn sl_pc_hasduration(sd: &mut MapSessionData, name: *const i8) -> i32 {
    ...
    for i in 0..MAX_MAGIC_TIMERS {
        if sd.player.spells.dura_aether[i].id == id as u16
            && sd.player.spells.dura_aether[i].duration > 0
        {
            return 1;
        }
    }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_setduration(
    sd: &mut MapSessionData,
    name: *const i8,
    mut time_ms: i32,
    caster_id: i32,
    ...
    for x in 0..MAX_MAGIC_TIMERS {
        ...
        if da_id == id as u16 && time_ms <= 0 && da_caster == caster_id as u32 && alreadycast {
            ...
            return;
        } else if da_id == id as u16
            && da_caster == caster_id as u32
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_flushduration(
    sd: &mut MapSessionData,
    _dispel_level: i32,
    min_id: i32,
    max_id: i32,
    ...
    for x in 0..MAX_MAGIC_TIMERS {
        ...
        if id == 0 || sd.player.spells.dura_aether[x].duration <= 0 {
            continue;
        }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_flushdurationnouncast(
    sd: &mut MapSessionData,
    dispel_level: i32,
    min_id: i32,
    max_id: i32,
...
pub unsafe fn sl_pc_setaether(sd: &mut MapSessionData, name: *const i8, mut time_ms: i32) {
    ...
    for x in 0..MAX_MAGIC_TIMERS {
        ...
        if da_id == id as u16 && time_ms <= 0 {
            ...
            clif_send_aether(&mut *sd, id, time_ms / 1000);
            return;
...
pub unsafe fn sl_pc_getaether(sd: &mut MapSessionData, name: *const i8) -> i32 {
    ...
    for i in 0..MAX_MAGIC_TIMERS {
        if sd.player.spells.dura_aether[i].id == id as u16 {
            return sd.player.spells.dura_aether[i].aether;
        }
    }
    0
}
...
pub unsafe fn sl_pc_flushaether(sd: &mut MapSessionData) {
    for i in 0..MAX_MAGIC_TIMERS {
        if sd.player.spells.dura_aether[i].aether > 0 {
            ...
            sd.player.spells.dura_aether[i].aether = 0;
            if aether_dur == 0 {
                sd.player.spells.dura_aether[i].id = 0;
            }
        }
    }
}
...
pub unsafe fn sl_pc_haslegend(sd: &mut MapSessionData, name: *const i8) -> i32 {
    ...
    for i in 0..MAX_LEGENDS {
        ...
        if leg_name[0] != 0 {
            ...
            if leg_bytes.eq_ignore_ascii_case(cmp) {
                return 1;
            }
        }
    }
...
pub fn sl_pc_getequippeddura(sd: &mut MapSessionData, id: u32, slot: i32) -> i32 {
    ...
    if slot >= 0 && (slot as usize) < MAX_EQUIP {
        let s = slot as usize;
        if sd.player.inventory.equip[s].id == id {
            return sd.player.inventory.equip[s].dura;
        }
    } else {
        for x in 0..MAX_EQUIP {
            if sd.player.inventory.equip[x].id == id {
                return sd.player.inventory.equip[x].dura;
            }
        }
    }
    -1
...
pub fn sl_pc_calcrangeddamage(_sd: &mut MapSessionData, _bl: *mut std::ffi::c_void) -> i32 {
    0
}
pub fn sl_pc_calcrangedhit(_sd: &mut MapSessionData, _bl: *mut std::ffi::c_void) -> i32 {
    0
}
...
pub fn sl_pc_checkbankitems(sd: &mut MapSessionData, slot: i32) -> i32 {
    if slot < 0 || slot as usize >= MAX_BANK_SLOTS {
        return 0;
    }
...
pub unsafe fn sl_pc_bankdeposit(
    ...
    let engrave_bytes: &[u8] = if engrave.is_null() {
        b"\0"
    } else {
        std::slice::from_raw_parts(engrave as *const u8, libc::strlen(engrave) + 1)
    };
    ...
    for x in 0..MAX_BANK_SLOTS {
        ...
        if b.item_id == item && b.owner == owner {
            ...
            if engrave_bytes.len() == rn_bytes.len() && engrave_bytes.eq_ignore_ascii_case(rn_bytes)
            {
                deposit = Some(x);
                break;
            }
    ...
    if let Some(x) = deposit {
        sd.player.inventory.banks[x].amount =
            sd.player.inventory.banks[x].amount.wrapping_add(amount);
    } else {
        for x in 0..MAX_BANK_SLOTS {
            if sd.player.inventory.banks[x].item_id == 0 {
                ...
                b.amount = amount;
                b.owner = owner;
                let src = if engrave.is_null() {
                    c"".as_ptr()
                } else {
                    engrave
                };
                libc::strncpy(b.real_name.as_mut_ptr(), src, b.real_name.len() - 1);
                break;
            }
        }
    }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_getparcel(_sd: &mut MapSessionData) -> *mut std::ffi::c_void {
    std::ptr::null_mut()
}
...
use crate::game::map_parse::chat::{
    clif_broadcast as clif_broadcast_pc, clif_sendmsg as clif_sendmsg_pc,
};
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_broadcast_sd(_sd: &mut MapSessionData, msg: *const i8, m: i32) {
    if msg.is_null() {
        return;
    }
...
pub unsafe fn sl_pc_getinventoryitem(sd: &mut MapSessionData, slot: i32) -> *mut std::ffi::c_void {
    ...
    if sd.player.inventory.inventory[slot as usize].id == 0 {
        return std::ptr::null_mut();
    }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_getequippeditem_sd(
    sd: &mut MapSessionData,
    slot: i32,
) -> *mut std::ffi::c_void {
    if slot < 0 || slot as usize >= MAX_EQUIP {
    ...
    if sd.player.inventory.equip[slot as usize].id == 0 {
        return std::ptr::null_mut();
    }
...
pub unsafe fn sl_pc_additem(
    ...
    fl.dura = if dura != 0 {
        ...
        crate::database::item_db::search(id).dura
    };
...
pub unsafe fn sl_pc_removeitem(
    ...
    let engrave = if engrave.is_null() {
        c"".as_ptr()
    } else {
        engrave
    };
    ...
    for x in 0..maxinv {
        ...
        if owner != 0 && inv.owner != owner {
            continue;
        }
        if libc::strcasecmp(inv.real_name.as_ptr(), engrave) != 0 {
            continue;
        }
        ...
        if let Some(arc) = map_id2sd_pc(pc_id) {
            crate::game::pc::pc_delitem(&arc, x as i32, take as i32, type_);
        }
        amount -= take;
    }
}
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_removeitemdura(sd: &mut MapSessionData, id: u32, mut amount: u32, type_: i32) {
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_hasitemdura(sd: &mut MapSessionData, id: u32, mut amount: u32) -> i32 {
    let max_dura = crate::database::item_db::search(id).dura;
    let maxinv = sd.player.inventory.max_inv as usize;
    for x in 0..maxinv {
        if amount == 0 {
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_getspells(sd: &mut MapSessionData, out_ids: *mut i32, max: i32) -> i32 {
    if out_ids.is_null() {
        return 0;
    }
    let mut count = 0i32;
...
pub unsafe fn sl_pc_getspellnames(
    ...
    for x in 0..MAX_SPELLS {
        ...
        if sd.player.spells.skills[x] != 0 {
            *out_names.add(count as usize) = magic_db::search(sd.player.spells.skills[x] as i32)
                .name
                .as_ptr();
            count += 1;
        }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_getlegend(sd: &mut MapSessionData, name: *const i8) -> *const i8 {
    if name.is_null() {
        return std::ptr::null();
    }
    for x in 0..MAX_LEGENDS {
...
pub unsafe fn sl_pc_activespells(sd: &mut MapSessionData, name: *const i8) -> i32 {
    ...
    for x in 0..MAX_MAGIC_TIMERS {
        let da = &sd.player.spells.dura_aether[x];
        if da.id as i32 == id && da.duration > 0 {
            return 1;
        }
    }
    0
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_checkclankitemamounts(sd: &mut MapSessionData, item: i32, _amount: i32) -> i32 {
    let clan = crate::database::clan_db::search(sd.player.social.clan as i32);
    if clan.clanbanks.is_null() {
        return 0;
    }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_getcreationitems(sd: &mut MapSessionData, len: i32, out: *mut u32) -> i32 {
    if out.is_null() {
        return 0;
    }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_getcreationamounts(sd: &mut MapSessionData, len: i32, item_id: u32) -> i32 {
...
use crate::game::map_parse::dialogs::{
    clif_buydialog as clif_buydialog_pc, clif_input as clif_input_pc,
    clif_scriptmenuseq as clif_scriptmenuseq_pc, clif_scriptmes as clif_scriptmes_pc,
    clif_selldialog as clif_selldialog_pc,
};
...
pub unsafe fn sl_pc_input_send(sd: &mut MapSessionData, msg: *const i8) {
    ...
    if let Some(arc) = map_id2sd_pc(sd.id) {
        clif_input_pc(&arc, last_click as i32, msg, c"".as_ptr());
    }
}
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_dialog_send(sd: &mut MapSessionData, msg: *const i8, prev: i32, next: i32) {
    let last_click = sd.last_click;
    if let Some(arc) = map_id2sd_pc(sd.id) {
        clif_scriptmes_pc(&arc, last_click as i32, msg, prev, next);
    }
}
...
pub unsafe fn sl_pc_dialogseq_send(
    ...
    let last_click = sd.last_click;
    if let Some(arc) = map_id2sd_pc(sd.id) {
        clif_scriptmes_pc(&arc, last_click as i32, cmsg.as_ptr(), 0, can_continue);
    }
}
...
unsafe fn menu_send_1idx(
    ...
    let last_click = sd.last_click;
    if let Some(arc) = map_id2sd_pc(sd.id) {
        clif_scriptmenuseq_pc(&arc, last_click as i32, msg, buf.as_mut_ptr(), n, 0, 0);
    }
}
...
pub unsafe fn sl_pc_buy_send(
    ...
    items: *const i32,
    values: *const i32,
    displaynames: *const *const i8,
    buytext: *const *const i8,
    n: i32,
) {
    if n <= 0 {
        return;
    ...
    for (i, item) in ilist.iter_mut().enumerate().take(nu) {
        ...
        if !buytext.is_null() && !(*buytext.add(i)).is_null() {
            libc::strncpy(
                item.buytext.as_mut_ptr() as *mut i8,
                *buytext.add(i),
                item.buytext.len() - 1,
            );
        }
...
unsafe fn sell_send_inner(sd: &mut MapSessionData, msg: *const i8, items: *const i32, n: i32) {
    ...
    for j in 0..nu {
        ...
        for x in 0..maxinv {
            if sd.player.inventory.inventory[x].id == item_id {
                slots.push(x as i32);
            }
        }
    }
    let last_click = sd.last_click;
    if let Some(arc) = map_id2sd_pc(sd.id) {
        clif_selldialog_pc(&arc, last_click, msg, slots.as_ptr(), slots.len() as i32);
    }
}
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_sell_send(sd: &mut MapSessionData, msg: *const i8, items: *const i32, n: i32) {
    if n <= 0 {
        return;
    }
...
///
/// Caller must ensure all pointer arguments are valid and non-null.
pub unsafe fn sl_pc_sell2_send(sd: &mut MapSessionData, msg: *const i8, items: *const i32, n: i32) {
...
pub unsafe fn sl_pc_removeparcel(
    ...
    let _ = crate::database::blocking_run_async(async move {
        sqlx::query("DELETE FROM `Parcels` WHERE `ParChaIdDestination`=? AND `ParPosition`=?")
            .bind(char_id)
            .bind(pos)
            .execute(crate::database::get_pool())
            .await
...
pub unsafe fn sl_pc_expireitem(sd: &mut MapSessionData) {
    ...
    for x in 0..sd.player.inventory.max_inv as usize {
        ...
        if (slot_t > 0 && slot_t < t) || (item_t > 0 && item_t < t) {
            ...
            let msg = format!(
                "Your {} has expired! Please visit the cash shop to purchase another.",
                name
            );
            if let Ok(cmsg) = std::ffi::CString::new(msg) {
                if let Some(ref arc) = pe {
                    pc_delitem(arc, x as i32, 1, 8);
                }
                if let Some(ref arc) = pe {
...
pub unsafe fn sl_pc_addhealth2(sd: &mut MapSessionData, amount: i32, _type: i32) {
    if sd.attacker != 0 && amount > 0 {
        dispatch("player_combat", Some("on_healed"), &[sd.id, sd.attacker]);
    } else if amount > 0 {
        dispatch("player_combat", Some("on_healed"), &[sd.id]);
    }
    clif_send_pc_healthscript(&mut *sd, -amount, 0);
    if let Some(arc) = map_id2sd_pc(sd.id) {
        clif_sendstatus(&arc, SFLAG_HPMP);
