...
pub unsafe fn sl_pc_bl_id(sd: *mut MapSessionData) -> i32   { (*sd).bl.id as i32 }
pub unsafe fn sl_pc_bl_m(sd: *mut MapSessionData) -> i32    { (*sd).bl.m as i32 }
pub unsafe fn sl_pc_bl_x(sd: *mut MapSessionData) -> i32    { (*sd).bl.x as i32 }
pub unsafe fn sl_pc_bl_y(sd: *mut MapSessionData) -> i32    { (*sd).bl.y as i32 }
pub unsafe fn sl_pc_bl_type(sd: *mut MapSessionData) -> i32 { (*sd).bl.bl_type as i32 }

// ─── Read: status fields ──────────────────────────────────────────────────────

pub unsafe fn sl_pc_status_id(sd: *mut MapSessionData) -> i32          { (*sd).status.id as i32 }
pub unsafe fn sl_pc_status_hp(sd: *mut MapSessionData) -> i32          { (*sd).status.hp as i32 }
pub unsafe fn sl_pc_status_mp(sd: *mut MapSessionData) -> i32          { (*sd).status.mp as i32 }
pub unsafe fn sl_pc_status_level(sd: *mut MapSessionData) -> i32       { (*sd).status.level as i32 }
pub unsafe fn sl_pc_status_exp(sd: *mut MapSessionData) -> i32         { (*sd).status.exp as i32 }
pub unsafe fn sl_pc_status_expsoldmagic(sd: *mut MapSessionData) -> i32{ (*sd).status.expsold_magic as i32 } // truncates to low 32 bits; matches C
...
pub unsafe fn sl_pc_status_expsoldhealth(sd: *mut MapSessionData) -> i32 { (*sd).status.expsold_health as i32 } // truncates to low 32 bits; matches C
pub unsafe fn sl_pc_status_expsoldstats(sd: *mut MapSessionData) -> i32  { (*sd).status.expsold_stats as i32 } // truncates to low 32 bits; matches C
pub unsafe fn sl_pc_status_class(sd: *mut MapSessionData) -> i32     { (*sd).status.class as i32 }
pub unsafe fn sl_pc_status_totem(sd: *mut MapSessionData) -> i32     { (*sd).status.totem as i32 }
pub unsafe fn sl_pc_status_tier(sd: *mut MapSessionData) -> i32      { (*sd).status.tier as i32 }
pub unsafe fn sl_pc_status_mark(sd: *mut MapSessionData) -> i32      { (*sd).status.mark as i32 }
pub unsafe fn sl_pc_status_country(sd: *mut MapSessionData) -> i32   { (*sd).status.country as i32 }
pub unsafe fn sl_pc_status_clan(sd: *mut MapSessionData) -> i32      { (*sd).status.clan as i32 }
pub unsafe fn sl_pc_status_gm_level(sd: *mut MapSessionData) -> i32  { (*sd).status.gm_level as i32 }
pub unsafe fn sl_pc_status_sex(sd: *mut MapSessionData) -> i32       { (*sd).status.sex as i32 }
pub unsafe fn sl_pc_status_side(sd: *mut MapSessionData) -> i32      { (*sd).status.side as i32 }
pub unsafe fn sl_pc_status_state(sd: *mut MapSessionData) -> i32     { (*sd).status.state as i32 }
pub unsafe fn sl_pc_status_face(sd: *mut MapSessionData) -> i32      { (*sd).status.face as i32 }
pub unsafe fn sl_pc_status_hair(sd: *mut MapSessionData) -> i32      { (*sd).status.hair as i32 }
pub unsafe fn sl_pc_status_hair_color(sd: *mut MapSessionData) -> i32  { (*sd).status.hair_color as i32 }
pub unsafe fn sl_pc_status_face_color(sd: *mut MapSessionData) -> i32  { (*sd).status.face_color as i32 }
pub unsafe fn sl_pc_status_armor_color(sd: *mut MapSessionData) -> i32 { (*sd).status.armor_color as i32 }
pub unsafe fn sl_pc_status_skin_color(sd: *mut MapSessionData) -> i32  { (*sd).status.skin_color as i32 }
pub unsafe fn sl_pc_status_basehp(sd: *mut MapSessionData) -> i32    { (*sd).status.basehp as i32 }
pub unsafe fn sl_pc_status_basemp(sd: *mut MapSessionData) -> i32    { (*sd).status.basemp as i32 }
pub unsafe fn sl_pc_status_money(sd: *mut MapSessionData) -> i32     { (*sd).status.money as i32 }
pub unsafe fn sl_pc_status_bankmoney(sd: *mut MapSessionData) -> i32 { (*sd).status.bankmoney as i32 }
pub unsafe fn sl_pc_status_maxslots(sd: *mut MapSessionData) -> i32  { (*sd).status.maxslots as i32 }
pub unsafe fn sl_pc_status_maxinv(sd: *mut MapSessionData) -> i32    { (*sd).status.maxinv as i32 }
pub unsafe fn sl_pc_status_partner(sd: *mut MapSessionData) -> i32   { (*sd).status.partner as i32 }
pub unsafe fn sl_pc_status_pk(sd: *mut MapSessionData) -> i32        { (*sd).status.pk as i32 }
pub unsafe fn sl_pc_status_killedby(sd: *mut MapSessionData) -> i32  { (*sd).status.killedby as i32 }
pub unsafe fn sl_pc_status_killspk(sd: *mut MapSessionData) -> i32   { (*sd).status.killspk as i32 }
pub unsafe fn sl_pc_status_pkduration(sd: *mut MapSessionData) -> i32{ (*sd).status.pkduration as i32 }
pub unsafe fn sl_pc_status_basegrace(sd: *mut MapSessionData) -> i32 { (*sd).status.basegrace as i32 }
pub unsafe fn sl_pc_status_basemight(sd: *mut MapSessionData) -> i32 { (*sd).status.basemight as i32 }
pub unsafe fn sl_pc_status_basewill(sd: *mut MapSessionData) -> i32  { (*sd).status.basewill as i32 }
pub unsafe fn sl_pc_status_basearmor(sd: *mut MapSessionData) -> i32 { (*sd).status.basearmor as i32 }
pub unsafe fn sl_pc_status_tutor(sd: *mut MapSessionData) -> i32     { (*sd).status.tutor as i32 }
pub unsafe fn sl_pc_status_karma(sd: *mut MapSessionData) -> i32     { (*sd).status.karma as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_status_alignment(sd: *mut MapSessionData) -> i32 { (*sd).status.alignment as i32 }
pub unsafe fn sl_pc_status_classRank(sd: *mut MapSessionData) -> i32 { (*sd).status.class_rank as i32 }
pub unsafe fn sl_pc_status_clanRank(sd: *mut MapSessionData) -> i32  { (*sd).status.clan_rank as i32 }
pub unsafe fn sl_pc_status_novice_chat(sd: *mut MapSessionData) -> i32 { (*sd).status.novice_chat as i32 }
pub unsafe fn sl_pc_status_subpath_chat(sd: *mut MapSessionData) -> i32{ (*sd).status.subpath_chat as i32 }
pub unsafe fn sl_pc_status_clan_chat(sd: *mut MapSessionData) -> i32  { (*sd).status.clan_chat as i32 }
pub unsafe fn sl_pc_status_miniMapToggle(sd: *mut MapSessionData) -> i32{ (*sd).status.mini_map_toggle as i32 }
pub unsafe fn sl_pc_status_heroes(sd: *mut MapSessionData) -> i32    { (*sd).status.heroes as i32 }
pub unsafe fn sl_pc_status_mute(sd: *mut MapSessionData) -> i32      { (*sd).status.mute as i32 }
pub unsafe fn sl_pc_status_settingFlags(sd: *mut MapSessionData) -> i32{ (*sd).status.setting_flags as i32 }
// sl_pc_status_killspvp reads from the direct USER field `killspvp`, not status.killspvp
pub unsafe fn sl_pc_status_killspvp(sd: *mut MapSessionData) -> i32  { (*sd).killspvp as i32 }
pub unsafe fn sl_pc_status_profile_vitastats(sd: *mut MapSessionData) -> i32  { (*sd).status.profile_vitastats as i32 }
pub unsafe fn sl_pc_status_profile_equiplist(sd: *mut MapSessionData) -> i32  { (*sd).status.profile_equiplist as i32 }
pub unsafe fn sl_pc_status_profile_legends(sd: *mut MapSessionData) -> i32    { (*sd).status.profile_legends as i32 }
pub unsafe fn sl_pc_status_profile_spells(sd: *mut MapSessionData) -> i32     { (*sd).status.profile_spells as i32 }
pub unsafe fn sl_pc_status_profile_inventory(sd: *mut MapSessionData) -> i32  { (*sd).status.profile_inventory as i32 }
pub unsafe fn sl_pc_status_profile_bankitems(sd: *mut MapSessionData) -> i32  { (*sd).status.profile_bankitems as i32 }

// String getters — status fields are fixed-size [i8; N] arrays; return pointer to first element.
pub unsafe fn sl_pc_status_name(sd: *mut MapSessionData) -> *const i8 {
    (*sd).status.name.as_ptr()
}
pub unsafe fn sl_pc_status_title(sd: *mut MapSessionData) -> *const i8 {
    (*sd).status.title.as_ptr()
}
pub unsafe fn sl_pc_status_clan_title(sd: *mut MapSessionData) -> *const i8 {
    (*sd).status.clan_title.as_ptr()
}
pub unsafe fn sl_pc_status_afkmessage(sd: *mut MapSessionData) -> *const i8 {
    (*sd).status.afkmessage.as_ptr()
}
pub unsafe fn sl_pc_status_f1name(sd: *mut MapSessionData) -> *const i8 {
...
pub unsafe fn sl_pc_npc_g(sd: *mut MapSessionData) -> i32        { (*sd).npc_g }
pub unsafe fn sl_pc_npc_gc(sd: *mut MapSessionData) -> i32       { (*sd).npc_gc }
pub unsafe fn sl_pc_groupid(sd: *mut MapSessionData) -> i32      { (*sd).groupid as i32 }
pub unsafe fn sl_pc_time(sd: *mut MapSessionData) -> i32         { (*sd).time }
pub unsafe fn sl_pc_fakeDrop(sd: *mut MapSessionData) -> i32     { (*sd).fakeDrop as i32 }
pub unsafe fn sl_pc_max_hp(sd: *mut MapSessionData) -> i32       { (*sd).max_hp as i32 }
pub unsafe fn sl_pc_max_mp(sd: *mut MapSessionData) -> i32       { (*sd).max_mp as i32 }
pub unsafe fn sl_pc_lastvita(sd: *mut MapSessionData) -> i32     { (*sd).lastvita as i32 }
pub unsafe fn sl_pc_rage(sd: *mut MapSessionData) -> i32         { (*sd).rage as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_polearm(sd: *mut MapSessionData) -> i32      { (*sd).polearm }
pub unsafe fn sl_pc_last_click(sd: *mut MapSessionData) -> i32   { (*sd).last_click as i32 }
pub unsafe fn sl_pc_grace(sd: *mut MapSessionData) -> i32        { (*sd).grace }
pub unsafe fn sl_pc_might(sd: *mut MapSessionData) -> i32        { (*sd).might }
pub unsafe fn sl_pc_will(sd: *mut MapSessionData) -> i32         { (*sd).will }
pub unsafe fn sl_pc_armor(sd: *mut MapSessionData) -> i32        { (*sd).armor }
pub unsafe fn sl_pc_dam(sd: *mut MapSessionData) -> i32          { (*sd).dam }
pub unsafe fn sl_pc_hit(sd: *mut MapSessionData) -> i32          { (*sd).hit }
pub unsafe fn sl_pc_miss(sd: *mut MapSessionData) -> i32         { (*sd).miss as i32 }
pub unsafe fn sl_pc_sleep(sd: *mut MapSessionData) -> i32        { (*sd).sleep as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_set_sleep(sd: *mut MapSessionData, v: i32)   { (*sd).sleep = v as f32; }
pub unsafe fn sl_pc_attack_speed(sd: *mut MapSessionData) -> i32 { (*sd).attack_speed as i32 }
pub unsafe fn sl_pc_enchanted(sd: *mut MapSessionData) -> i32    { (*sd).enchanted as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_confused(sd: *mut MapSessionData) -> i32     { (*sd).confused as i32 }
pub unsafe fn sl_pc_target(sd: *mut MapSessionData) -> i32       { (*sd).target }
pub unsafe fn sl_pc_set_target(sd: *mut MapSessionData, v: i32)  { (*sd).target = v; }
pub unsafe fn sl_pc_deduction(sd: *mut MapSessionData) -> i32    { (*sd).deduction as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_speed(sd: *mut MapSessionData) -> i32        { (*sd).speed }
pub unsafe fn sl_pc_disguise(sd: *mut MapSessionData) -> i32     { (*sd).disguise as i32 }
pub unsafe fn sl_pc_disguise_color(sd: *mut MapSessionData) -> i32 { (*sd).disguise_color as i32 }
pub unsafe fn sl_pc_attacker(sd: *mut MapSessionData) -> i32     { (*sd).attacker as i32 }
pub unsafe fn sl_pc_invis(sd: *mut MapSessionData) -> i32        { (*sd).invis as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_damage(sd: *mut MapSessionData) -> i32       { (*sd).damage as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_crit(sd: *mut MapSessionData) -> i32         { (*sd).crit }
pub unsafe fn sl_pc_critchance(sd: *mut MapSessionData) -> i32   { (*sd).critchance }
pub unsafe fn sl_pc_critmult(sd: *mut MapSessionData) -> i32     { (*sd).critmult as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_rangeTarget(sd: *mut MapSessionData) -> i32  { (*sd).rangeTarget as i32 }
pub unsafe fn sl_pc_exchange_gold(sd: *mut MapSessionData) -> i32  { (*sd).exchange.gold as i32 }
pub unsafe fn sl_pc_exchange_count(sd: *mut MapSessionData) -> i32 { (*sd).exchange.item_count }
pub unsafe fn sl_pc_bod_count(sd: *mut MapSessionData) -> i32    { (*sd).boditems.bod_count }
pub unsafe fn sl_pc_paralyzed(sd: *mut MapSessionData) -> i32    { (*sd).paralyzed }
pub unsafe fn sl_pc_blind(sd: *mut MapSessionData) -> i32        { (*sd).blind }
pub unsafe fn sl_pc_drunk(sd: *mut MapSessionData) -> i32        { (*sd).drunk }
pub unsafe fn sl_pc_board(sd: *mut MapSessionData) -> i32        { (*sd).board }
pub unsafe fn sl_pc_board_candel(sd: *mut MapSessionData) -> i32 { (*sd).board_candel }
pub unsafe fn sl_pc_board_canwrite(sd: *mut MapSessionData) -> i32 { (*sd).board_canwrite }
pub unsafe fn sl_pc_boardshow(sd: *mut MapSessionData) -> i32    { (*sd).boardshow as i32 }
pub unsafe fn sl_pc_boardnameval(sd: *mut MapSessionData) -> i32 { (*sd).boardnameval as i32 }
pub unsafe fn sl_pc_msPing(sd: *mut MapSessionData) -> i32       { (*sd).msPing }
pub unsafe fn sl_pc_pbColor(sd: *mut MapSessionData) -> i32      { (*sd).pbColor }
pub unsafe fn sl_pc_coref(sd: *mut MapSessionData) -> i32        { (*sd).coref as i32 }
pub unsafe fn sl_pc_optFlags(sd: *mut MapSessionData) -> i32     { (*sd).optFlags as i32 } // u64 (64-bit); truncates to low 32 bits; matches C
pub unsafe fn sl_pc_snare(sd: *mut MapSessionData) -> i32        { (*sd).snare }
pub unsafe fn sl_pc_silence(sd: *mut MapSessionData) -> i32      { (*sd).silence }
pub unsafe fn sl_pc_extendhit(sd: *mut MapSessionData) -> i32    { (*sd).extendhit }
pub unsafe fn sl_pc_afk(sd: *mut MapSessionData) -> i32          { (*sd).afk }
pub unsafe fn sl_pc_afktime(sd: *mut MapSessionData) -> i32      { (*sd).afktime }
pub unsafe fn sl_pc_totalafktime(sd: *mut MapSessionData) -> i32 { (*sd).totalafktime }
pub unsafe fn sl_pc_backstab(sd: *mut MapSessionData) -> i32     { (*sd).backstab }
pub unsafe fn sl_pc_flank(sd: *mut MapSessionData) -> i32        { (*sd).flank }
pub unsafe fn sl_pc_healing(sd: *mut MapSessionData) -> i32      { (*sd).healing }
pub unsafe fn sl_pc_minSdam(sd: *mut MapSessionData) -> i32      { (*sd).minSdam }
pub unsafe fn sl_pc_maxSdam(sd: *mut MapSessionData) -> i32      { (*sd).maxSdam }
pub unsafe fn sl_pc_minLdam(sd: *mut MapSessionData) -> i32      { (*sd).minLdam }
pub unsafe fn sl_pc_maxLdam(sd: *mut MapSessionData) -> i32      { (*sd).maxLdam }
pub unsafe fn sl_pc_talktype(sd: *mut MapSessionData) -> i32     { (*sd).talktype as i32 }
pub unsafe fn sl_pc_equipid(sd: *mut MapSessionData) -> i32      { (*sd).equipid as i32 }
pub unsafe fn sl_pc_takeoffid(sd: *mut MapSessionData) -> i32    { (*sd).takeoffid as i32 }
pub unsafe fn sl_pc_breakid(sd: *mut MapSessionData) -> i32      { (*sd).breakid as i32 }
pub unsafe fn sl_pc_equipslot(sd: *mut MapSessionData) -> i32    { (*sd).equipslot as i32 }
pub unsafe fn sl_pc_invslot(sd: *mut MapSessionData) -> i32      { (*sd).invslot as i32 }
pub unsafe fn sl_pc_pickuptype(sd: *mut MapSessionData) -> i32   { (*sd).pickuptype as i32 }
pub unsafe fn sl_pc_spottraps(sd: *mut MapSessionData) -> i32    { (*sd).spottraps as i32 }
pub unsafe fn sl_pc_fury(sd: *mut MapSessionData) -> i32         { (*sd).fury as i32 } // truncates float to int; matches C
// status.equip[EQ_FACEACCTWO] — Item.id and Item.custom are both u32
pub unsafe fn sl_pc_faceacctwo_id(sd: *mut MapSessionData) -> i32 {
    (*sd).status.equip[EQ_FACEACCTWO as usize].id as i32
}
pub unsafe fn sl_pc_faceacctwo_custom(sd: *mut MapSessionData) -> i32 {
    (*sd).status.equip[EQ_FACEACCTWO as usize].custom as i32
}
pub unsafe fn sl_pc_protection(sd: *mut MapSessionData) -> i32   { (*sd).protection as i32 }
pub unsafe fn sl_pc_clone(sd: *mut MapSessionData) -> i32        { (*sd).clone as i32 }
pub unsafe fn sl_pc_wisdom(sd: *mut MapSessionData) -> i32       { (*sd).wisdom }
pub unsafe fn sl_pc_con(sd: *mut MapSessionData) -> i32          { (*sd).con as i32 }
pub unsafe fn sl_pc_deathflag(sd: *mut MapSessionData) -> i32    { (*sd).deathflag as i32 }
pub unsafe fn sl_pc_selfbar(sd: *mut MapSessionData) -> i32      { (*sd).selfbar as i32 }
pub unsafe fn sl_pc_groupbars(sd: *mut MapSessionData) -> i32    { (*sd).groupbars as i32 }
pub unsafe fn sl_pc_mobbars(sd: *mut MapSessionData) -> i32      { (*sd).mobbars as i32 }
pub unsafe fn sl_pc_disptimertick(sd: *mut MapSessionData) -> i32 { (*sd).disptimertick as i32 }
pub unsafe fn sl_pc_bindmap(sd: *mut MapSessionData) -> i32      { (*sd).bindmap as i32 }
pub unsafe fn sl_pc_bindx(sd: *mut MapSessionData) -> i32        { (*sd).bindx }
pub unsafe fn sl_pc_bindy(sd: *mut MapSessionData) -> i32        { (*sd).bindy }
pub unsafe fn sl_pc_ambushtimer(sd: *mut MapSessionData) -> i32  { (*sd).ambushtimer as i32 } // u64 (64-bit); truncates to low 32 bits; matches C
pub unsafe fn sl_pc_dialogtype(sd: *mut MapSessionData) -> i32   { (*sd).dialogtype as i32 }
pub unsafe fn sl_pc_set_dialogtype(sd: *mut MapSessionData, v: i32) { (*sd).dialogtype = v as i8; }
pub unsafe fn sl_pc_cursed(sd: *mut MapSessionData) -> i32       { (*sd).cursed as i32 }
pub unsafe fn sl_pc_action(sd: *mut MapSessionData) -> i32       { (*sd).action as i32 }
pub unsafe fn sl_pc_scripttick(sd: *mut MapSessionData) -> i32   { (*sd).scripttick }
pub unsafe fn sl_pc_dmgshield(sd: *mut MapSessionData) -> i32    { (*sd).dmgshield as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_dmgdealt(sd: *mut MapSessionData) -> i32     { (*sd).dmgdealt as i32 } // truncates float to int; matches C
pub unsafe fn sl_pc_dmgtaken(sd: *mut MapSessionData) -> i32     { (*sd).dmgtaken as i32 } // truncates float to int; matches C

// String getters — direct USER char array fields; return pointer to first element.
pub unsafe fn sl_pc_ipaddress(sd: *mut MapSessionData) -> *const i8 {
    (*sd).ipaddress.as_ptr()
}
pub unsafe fn sl_pc_speech(sd: *mut MapSessionData) -> *const i8 {
    (*sd).speech.as_ptr()
}
pub unsafe fn sl_pc_question(sd: *mut MapSessionData) -> *const i8 {
    (*sd).question.as_ptr()
}
pub unsafe fn sl_pc_mail(sd: *mut MapSessionData) -> *const i8 {
    (*sd).mail.as_ptr()
}
...
pub unsafe fn sl_pc_gfx_face(sd: *mut MapSessionData) -> i32     { (*sd).gfx.face as i32 }
pub unsafe fn sl_pc_gfx_hair(sd: *mut MapSessionData) -> i32     { (*sd).gfx.hair as i32 }
pub unsafe fn sl_pc_gfx_chair(sd: *mut MapSessionData) -> i32    { (*sd).gfx.chair as i32 }
pub unsafe fn sl_pc_gfx_cface(sd: *mut MapSessionData) -> i32    { (*sd).gfx.cface as i32 }
pub unsafe fn sl_pc_gfx_cskin(sd: *mut MapSessionData) -> i32    { (*sd).gfx.cskin as i32 }
pub unsafe fn sl_pc_gfx_dye(sd: *mut MapSessionData) -> i32      { (*sd).gfx.dye as i32 }
pub unsafe fn sl_pc_gfx_weapon(sd: *mut MapSessionData) -> i32   { (*sd).gfx.weapon as i32 }
pub unsafe fn sl_pc_gfx_cweapon(sd: *mut MapSessionData) -> i32  { (*sd).gfx.cweapon as i32 }
pub unsafe fn sl_pc_gfx_armor(sd: *mut MapSessionData) -> i32    { (*sd).gfx.armor as i32 }
pub unsafe fn sl_pc_gfx_carmor(sd: *mut MapSessionData) -> i32   { (*sd).gfx.carmor as i32 }
pub unsafe fn sl_pc_gfx_shield(sd: *mut MapSessionData) -> i32   { (*sd).gfx.shield as i32 }
pub unsafe fn sl_pc_gfx_cshield(sd: *mut MapSessionData) -> i32  { (*sd).gfx.cshield as i32 }
pub unsafe fn sl_pc_gfx_helm(sd: *mut MapSessionData) -> i32     { (*sd).gfx.helm as i32 }
pub unsafe fn sl_pc_gfx_chelm(sd: *mut MapSessionData) -> i32    { (*sd).gfx.chelm as i32 }
pub unsafe fn sl_pc_gfx_mantle(sd: *mut MapSessionData) -> i32   { (*sd).gfx.mantle as i32 }
pub unsafe fn sl_pc_gfx_cmantle(sd: *mut MapSessionData) -> i32  { (*sd).gfx.cmantle as i32 }
pub unsafe fn sl_pc_gfx_crown(sd: *mut MapSessionData) -> i32    { (*sd).gfx.crown as i32 }
pub unsafe fn sl_pc_gfx_ccrown(sd: *mut MapSessionData) -> i32   { (*sd).gfx.ccrown as i32 }
pub unsafe fn sl_pc_gfx_faceAcc(sd: *mut MapSessionData) -> i32  { (*sd).gfx.face_acc as i32 }
pub unsafe fn sl_pc_gfx_cfaceAcc(sd: *mut MapSessionData) -> i32 { (*sd).gfx.cface_acc as i32 }
pub unsafe fn sl_pc_gfx_faceAccT(sd: *mut MapSessionData) -> i32 { (*sd).gfx.face_acc_t as i32 }
pub unsafe fn sl_pc_gfx_cfaceAccT(sd: *mut MapSessionData) -> i32{ (*sd).gfx.cface_acc_t as i32 }
pub unsafe fn sl_pc_gfx_boots(sd: *mut MapSessionData) -> i32    { (*sd).gfx.boots as i32 }
pub unsafe fn sl_pc_gfx_cboots(sd: *mut MapSessionData) -> i32   { (*sd).gfx.cboots as i32 }
pub unsafe fn sl_pc_gfx_necklace(sd: *mut MapSessionData) -> i32 { (*sd).gfx.necklace as i32 }
pub unsafe fn sl_pc_gfx_cnecklace(sd: *mut MapSessionData) -> i32{ (*sd).gfx.cnecklace as i32 }
pub unsafe fn sl_pc_gfx_name(sd: *mut MapSessionData) -> *const i8 {
    (*sd).gfx.name.as_ptr()
}
...
pub unsafe fn sl_pc_clanname(sd: *mut MapSessionData) -> *const i8 {
    clandb_name_ffi((*sd).status.clan as i32)
}

/// Returns the path (base class id) for this character's class.
pub unsafe fn sl_pc_baseclass(sd: *mut MapSessionData) -> i32 {
...
pub unsafe fn sl_pc_baseClassName(sd: *mut MapSessionData) -> *mut i8 {
...
/// The returned pointer is a leaked CString — Lua copies it immediately.
pub unsafe fn sl_pc_className(sd: *mut MapSessionData) -> *mut i8 {
    classdb_name_ffi((*sd).status.class as i32, 0)
}

/// Returns the display name of the character's class at their current mark (rank).
/// The returned pointer is a leaked CString — Lua copies it immediately.
pub unsafe fn sl_pc_classNameMark(sd: *mut MapSessionData) -> *mut i8 {
    let sd = sd;
...
// status.* setters
pub unsafe fn sl_pc_set_hp(sd: *mut MapSessionData, v: i32)         { (*sd).status.hp = v as u32; }
pub unsafe fn sl_pc_set_mp(sd: *mut MapSessionData, v: i32)         { (*sd).status.mp = v as u32; }
pub unsafe fn sl_pc_set_exp(sd: *mut MapSessionData, v: i32)        { (*sd).status.exp = v as u32; }
pub unsafe fn sl_pc_set_level(sd: *mut MapSessionData, v: i32)      { (*sd).status.level = v as u8; }
pub unsafe fn sl_pc_set_class(sd: *mut MapSessionData, v: i32)      { (*sd).status.class = v as u8; }
pub unsafe fn sl_pc_set_totem(sd: *mut MapSessionData, v: i32)      { (*sd).status.totem = v as u8; }
pub unsafe fn sl_pc_set_tier(sd: *mut MapSessionData, v: i32)       { (*sd).status.tier = v as u8; }
pub unsafe fn sl_pc_set_mark(sd: *mut MapSessionData, v: i32)       { (*sd).status.mark = v as u8; }
pub unsafe fn sl_pc_set_country(sd: *mut MapSessionData, v: i32)    { (*sd).status.country = v as i8; }
pub unsafe fn sl_pc_set_clan(sd: *mut MapSessionData, v: i32)       { (*sd).status.clan = v as u32; }
pub unsafe fn sl_pc_set_gm_level(sd: *mut MapSessionData, v: i32)   { (*sd).status.gm_level = v as i8; }
pub unsafe fn sl_pc_set_side(sd: *mut MapSessionData, v: i32)       { (*sd).status.side = v as i8; }
pub unsafe fn sl_pc_set_state(sd: *mut MapSessionData, v: i32)      { (*sd).status.state = v as i8; }
pub unsafe fn sl_pc_set_hair(sd: *mut MapSessionData, v: i32)       { (*sd).status.hair = v as u16; }
pub unsafe fn sl_pc_set_hair_color(sd: *mut MapSessionData, v: i32) { (*sd).status.hair_color = v as u16; }
pub unsafe fn sl_pc_set_face_color(sd: *mut MapSessionData, v: i32) { (*sd).status.face_color = v as u16; }
pub unsafe fn sl_pc_set_armor_color(sd: *mut MapSessionData, v: i32){ (*sd).status.armor_color = v as u16; }
pub unsafe fn sl_pc_set_skin_color(sd: *mut MapSessionData, v: i32) { (*sd).status.skin_color = v as u16; }
pub unsafe fn sl_pc_set_face(sd: *mut MapSessionData, v: i32)       { (*sd).status.face = v as u16; }
pub unsafe fn sl_pc_set_money(sd: *mut MapSessionData, v: i32)      { (*sd).status.money = v as u32; }
pub unsafe fn sl_pc_set_bankmoney(sd: *mut MapSessionData, v: i32)  { (*sd).status.bankmoney = v as u32; }
pub unsafe fn sl_pc_set_maxslots(sd: *mut MapSessionData, v: i32)   { (*sd).status.maxslots = v as u32; }
pub unsafe fn sl_pc_set_maxinv(sd: *mut MapSessionData, v: i32)     { (*sd).status.maxinv = v as u8; }
pub unsafe fn sl_pc_set_partner(sd: *mut MapSessionData, v: i32)    { (*sd).status.partner = v as u32; }
pub unsafe fn sl_pc_set_pk(sd: *mut MapSessionData, v: i32)         { (*sd).status.pk = v as u8; }
pub unsafe fn sl_pc_set_basehp(sd: *mut MapSessionData, v: i32)     { (*sd).status.basehp = v as u32; }
pub unsafe fn sl_pc_set_basemp(sd: *mut MapSessionData, v: i32)     { (*sd).status.basemp = v as u32; }
pub unsafe fn sl_pc_set_karma(sd: *mut MapSessionData, v: i32)      { (*sd).status.karma = v as f32; }
pub unsafe fn sl_pc_set_alignment(sd: *mut MapSessionData, v: i32)  { (*sd).status.alignment = v as i8; }
pub unsafe fn sl_pc_set_basegrace(sd: *mut MapSessionData, v: i32)  { (*sd).status.basegrace = v as u32; }
pub unsafe fn sl_pc_set_basemight(sd: *mut MapSessionData, v: i32)  { (*sd).status.basemight = v as u32; }
pub unsafe fn sl_pc_set_basewill(sd: *mut MapSessionData, v: i32)   { (*sd).status.basewill = v as u32; }
pub unsafe fn sl_pc_set_basearmor(sd: *mut MapSessionData, v: i32)  { (*sd).status.basearmor = v; }
pub unsafe fn sl_pc_set_novice_chat(sd: *mut MapSessionData, v: i32){ (*sd).status.novice_chat = v as i8; }
pub unsafe fn sl_pc_set_subpath_chat(sd: *mut MapSessionData, v: i32){ (*sd).status.subpath_chat = v as i8; }
pub unsafe fn sl_pc_set_clan_chat(sd: *mut MapSessionData, v: i32)  { (*sd).status.clan_chat = v as i8; }
pub unsafe fn sl_pc_set_tutor(sd: *mut MapSessionData, v: i32)      { (*sd).status.tutor = v as u8; }
pub unsafe fn sl_pc_set_profile_vitastats(sd: *mut MapSessionData, v: i32) { (*sd).status.profile_vitastats = v as u8; }
pub unsafe fn sl_pc_set_profile_equiplist(sd: *mut MapSessionData, v: i32) { (*sd).status.profile_equiplist = v as u8; }
pub unsafe fn sl_pc_set_profile_legends(sd: *mut MapSessionData, v: i32)   { (*sd).status.profile_legends = v as u8; }
pub unsafe fn sl_pc_set_profile_spells(sd: *mut MapSessionData, v: i32)    { (*sd).status.profile_spells = v as u8; }
pub unsafe fn sl_pc_set_profile_inventory(sd: *mut MapSessionData, v: i32) { (*sd).status.profile_inventory = v as u8; }
pub unsafe fn sl_pc_set_profile_bankitems(sd: *mut MapSessionData, v: i32) { (*sd).status.profile_bankitems = v as u8; }
pub unsafe fn sl_pc_set_mute(sd: *mut MapSessionData, v: i32)       { (*sd).status.mute = v as i8; }
// C casts to (unsigned int) but Rust field is u16; low 16 bits are preserved identically.
pub unsafe fn sl_pc_set_settingFlags(sd: *mut MapSessionData, v: i32) { (*sd).status.setting_flags = v as u16; }
pub unsafe fn sl_pc_set_heroshow(sd: *mut MapSessionData, v: i32)   { (*sd).status.heroes = v as u32; }
pub unsafe fn sl_pc_set_sex(sd: *mut MapSessionData, v: i32)        { (*sd).status.sex = v as i8; }
pub unsafe fn sl_pc_set_classRank(sd: *mut MapSessionData, v: i32)  { (*sd).status.class_rank = v; }
pub unsafe fn sl_pc_set_clanRank(sd: *mut MapSessionData, v: i32)   { (*sd).status.clan_rank = v; }
pub unsafe fn sl_pc_setminimaptoggle(sd: *mut MapSessionData, v: i32) { (*sd).status.mini_map_toggle = v as u32; }

// direct USER field setters
pub unsafe fn sl_pc_set_max_hp(sd: *mut MapSessionData, v: i32)     { (*sd).max_hp = v as u32; }
pub unsafe fn sl_pc_set_max_mp(sd: *mut MapSessionData, v: i32)     { (*sd).max_mp = v as u32; }
pub unsafe fn sl_pc_set_npc_g(sd: *mut MapSessionData, v: i32)      { (*sd).npc_g = v; }
pub unsafe fn sl_pc_set_npc_gc(sd: *mut MapSessionData, v: i32)     { (*sd).npc_gc = v; }
pub unsafe fn sl_pc_set_last_click(sd: *mut MapSessionData, v: i32) { (*sd).last_click = v as u32; }
pub unsafe fn sl_pc_set_time(sd: *mut MapSessionData, v: i32)       { (*sd).time = v; }
pub unsafe fn sl_pc_set_rage(sd: *mut MapSessionData, v: i32)       { (*sd).rage = v as f32; }
pub unsafe fn sl_pc_set_polearm(sd: *mut MapSessionData, v: i32)    { (*sd).polearm = v; }
pub unsafe fn sl_pc_set_deduction(sd: *mut MapSessionData, v: i32)  { (*sd).deduction = v as f32; }
pub unsafe fn sl_pc_set_speed(sd: *mut MapSessionData, v: i32)      { (*sd).speed = v; }
pub unsafe fn sl_pc_set_attacker(sd: *mut MapSessionData, v: i32)   { (*sd).attacker = v as u32; }
pub unsafe fn sl_pc_set_invis(sd: *mut MapSessionData, v: i32)      { (*sd).invis = v as f32; }
pub unsafe fn sl_pc_set_damage(sd: *mut MapSessionData, v: i32)     { (*sd).damage = v as f32; }
pub unsafe fn sl_pc_set_crit(sd: *mut MapSessionData, v: i32)       { (*sd).crit = v; }
pub unsafe fn sl_pc_set_critchance(sd: *mut MapSessionData, v: i32) { (*sd).critchance = v; }
pub unsafe fn sl_pc_set_critmult(sd: *mut MapSessionData, v: i32)   { (*sd).critmult = v as f32; }
pub unsafe fn sl_pc_set_rangeTarget(sd: *mut MapSessionData, v: i32){ (*sd).rangeTarget = v as u32; }
pub unsafe fn sl_pc_set_disguise(sd: *mut MapSessionData, v: i32)   { (*sd).disguise = v as u16; }
pub unsafe fn sl_pc_set_disguise_color(sd: *mut MapSessionData, v: i32) { (*sd).disguise_color = v as u16; }
pub unsafe fn sl_pc_set_paralyzed(sd: *mut MapSessionData, v: i32)  { (*sd).paralyzed = v; }
pub unsafe fn sl_pc_set_blind(sd: *mut MapSessionData, v: i32)      { (*sd).blind = v; }
pub unsafe fn sl_pc_set_drunk(sd: *mut MapSessionData, v: i32)      { (*sd).drunk = v; }
pub unsafe fn sl_pc_set_board_candel(sd: *mut MapSessionData, v: i32)  { (*sd).board_candel = v; }
pub unsafe fn sl_pc_set_board_canwrite(sd: *mut MapSessionData, v: i32){ (*sd).board_canwrite = v; }
pub unsafe fn sl_pc_set_boardshow(sd: *mut MapSessionData, v: i32)  { (*sd).boardshow = v as i8; }
pub unsafe fn sl_pc_set_boardnameval(sd: *mut MapSessionData, v: i32){ (*sd).boardnameval = v as i8; }
pub unsafe fn sl_pc_set_snare(sd: *mut MapSessionData, v: i32)      { (*sd).snare = v; }
pub unsafe fn sl_pc_set_silence(sd: *mut MapSessionData, v: i32)    { (*sd).silence = v; }
pub unsafe fn sl_pc_set_extendhit(sd: *mut MapSessionData, v: i32)  { (*sd).extendhit = v; }
pub unsafe fn sl_pc_set_afk(sd: *mut MapSessionData, v: i32)        { (*sd).afk = v; }
pub unsafe fn sl_pc_set_confused(sd: *mut MapSessionData, v: i32)   { (*sd).confused = v as u8; }
pub unsafe fn sl_pc_set_spottraps(sd: *mut MapSessionData, v: i32)  { (*sd).spottraps = v as u8; }
pub unsafe fn sl_pc_set_selfbar(sd: *mut MapSessionData, v: i32)    { (*sd).selfbar = v as i8; }
pub unsafe fn sl_pc_set_groupbars(sd: *mut MapSessionData, v: i32)  { (*sd).groupbars = v as i8; }
pub unsafe fn sl_pc_set_mobbars(sd: *mut MapSessionData, v: i32)    { (*sd).mobbars = v as i8; }
// C uses (unsigned int) for the XOR mask but uFlags is u64; XOR low 32 bits, upper preserved.
pub unsafe fn sl_pc_set_optFlags_xor(sd: *mut MapSessionData, v: i32) { (*sd).optFlags ^= v as u32 as u64; }
pub unsafe fn sl_pc_set_uflags_xor(sd: *mut MapSessionData, v: i32)   { (*sd).uFlags ^= v as u32 as u64; }
pub unsafe fn sl_pc_set_talktype(sd: *mut MapSessionData, v: i32)   { (*sd).talktype = v as u8; }
pub unsafe fn sl_pc_set_cursed(sd: *mut MapSessionData, v: i32)     { (*sd).cursed = v as u8; }
pub unsafe fn sl_pc_set_deathflag(sd: *mut MapSessionData, v: i32)  { (*sd).deathflag = v as i8; }
pub unsafe fn sl_pc_set_bindmap(sd: *mut MapSessionData, v: i32)    { (*sd).bindmap = v as u16; }
pub unsafe fn sl_pc_set_bindx(sd: *mut MapSessionData, v: i32)      { (*sd).bindx = v; }
pub unsafe fn sl_pc_set_bindy(sd: *mut MapSessionData, v: i32)      { (*sd).bindy = v; }
pub unsafe fn sl_pc_set_protection(sd: *mut MapSessionData, v: i32) { (*sd).protection = v as i16; }
pub unsafe fn sl_pc_set_dmgshield(sd: *mut MapSessionData, v: i32)  { (*sd).dmgshield = v as f32; }
pub unsafe fn sl_pc_set_dmgdealt(sd: *mut MapSessionData, v: i32)   { (*sd).dmgdealt = v as f64; }
pub unsafe fn sl_pc_set_dmgtaken(sd: *mut MapSessionData, v: i32)   { (*sd).dmgtaken = v as f64; }
pub unsafe fn sl_pc_set_fakeDrop(sd: *mut MapSessionData, v: i32)   { (*sd).fakeDrop = v as u8; }
pub unsafe fn sl_pc_set_clone(sd: *mut MapSessionData, v: i32)      { (*sd).clone = v as i8; }
pub unsafe fn sl_pc_set_fury(sd: *mut MapSessionData, v: i32)       { (*sd).fury = v as f32; }
pub unsafe fn sl_pc_set_coref_container(sd: *mut MapSessionData, v: i32) { (*sd).coref_container = v as u32; }
pub unsafe fn sl_pc_set_wisdom(sd: *mut MapSessionData, v: i32)     { (*sd).wisdom = v; }
pub unsafe fn sl_pc_set_con(sd: *mut MapSessionData, v: i32)        { (*sd).con = v as i16; }
pub unsafe fn sl_pc_set_backstab(sd: *mut MapSessionData, v: i32)   { (*sd).backstab = v; }
pub unsafe fn sl_pc_set_flank(sd: *mut MapSessionData, v: i32)      { (*sd).flank = v; }
pub unsafe fn sl_pc_set_healing(sd: *mut MapSessionData, v: i32)    { (*sd).healing = v; }
pub unsafe fn sl_pc_set_pbColor(sd: *mut MapSessionData, v: i32)    { (*sd).pbColor = v; }
...
pub unsafe fn sl_pc_set_gfx_face(sd: *mut MapSessionData, v: i32)     { (*sd).gfx.face = v as u8; }
pub unsafe fn sl_pc_set_gfx_hair(sd: *mut MapSessionData, v: i32)     { (*sd).gfx.hair = v as u8; }
pub unsafe fn sl_pc_set_gfx_chair(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.chair = v as u8; }
pub unsafe fn sl_pc_set_gfx_cface(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.cface = v as u8; }
pub unsafe fn sl_pc_set_gfx_cskin(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.cskin = v as u8; }
pub unsafe fn sl_pc_set_gfx_dye(sd: *mut MapSessionData, v: i32)      { (*sd).gfx.dye = v as u8; }
pub unsafe fn sl_pc_set_gfx_weapon(sd: *mut MapSessionData, v: i32)   { (*sd).gfx.weapon = v as u16; }
pub unsafe fn sl_pc_set_gfx_cweapon(sd: *mut MapSessionData, v: i32)  { (*sd).gfx.cweapon = v as u8; }
pub unsafe fn sl_pc_set_gfx_armor(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.armor = v as u16; }
pub unsafe fn sl_pc_set_gfx_carmor(sd: *mut MapSessionData, v: i32)   { (*sd).gfx.carmor = v as u8; }
pub unsafe fn sl_pc_set_gfx_shield(sd: *mut MapSessionData, v: i32)   { (*sd).gfx.shield = v as u16; }
pub unsafe fn sl_pc_set_gfx_cshield(sd: *mut MapSessionData, v: i32)  { (*sd).gfx.cshield = v as u8; }
pub unsafe fn sl_pc_set_gfx_helm(sd: *mut MapSessionData, v: i32)     { (*sd).gfx.helm = v as u16; }
pub unsafe fn sl_pc_set_gfx_chelm(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.chelm = v as u8; }
pub unsafe fn sl_pc_set_gfx_mantle(sd: *mut MapSessionData, v: i32)   { (*sd).gfx.mantle = v as u16; }
pub unsafe fn sl_pc_set_gfx_cmantle(sd: *mut MapSessionData, v: i32)  { (*sd).gfx.cmantle = v as u8; }
pub unsafe fn sl_pc_set_gfx_crown(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.crown = v as u16; }
pub unsafe fn sl_pc_set_gfx_ccrown(sd: *mut MapSessionData, v: i32)   { (*sd).gfx.ccrown = v as u8; }
pub unsafe fn sl_pc_set_gfx_faceAcc(sd: *mut MapSessionData, v: i32)  { (*sd).gfx.face_acc = v as u16; }
pub unsafe fn sl_pc_set_gfx_cfaceAcc(sd: *mut MapSessionData, v: i32) { (*sd).gfx.cface_acc = v as u8; }
pub unsafe fn sl_pc_set_gfx_faceAccT(sd: *mut MapSessionData, v: i32) { (*sd).gfx.face_acc_t = v as u16; }
pub unsafe fn sl_pc_set_gfx_cfaceAccT(sd: *mut MapSessionData, v: i32){ (*sd).gfx.cface_acc_t = v as u8; }
pub unsafe fn sl_pc_set_gfx_boots(sd: *mut MapSessionData, v: i32)    { (*sd).gfx.boots = v as u16; }
pub unsafe fn sl_pc_set_gfx_cboots(sd: *mut MapSessionData, v: i32)   { (*sd).gfx.cboots = v as u8; }
pub unsafe fn sl_pc_set_gfx_necklace(sd: *mut MapSessionData, v: i32) { (*sd).gfx.necklace = v as u16; }
pub unsafe fn sl_pc_set_gfx_cnecklace(sd: *mut MapSessionData, v: i32){ (*sd).gfx.cnecklace = v as u8; }
...
pub unsafe fn sl_pc_fd(sd: *mut MapSessionData) -> i32 {
    (*sd).fd
}
pub unsafe fn sl_pc_chat_timer(sd: *mut MapSessionData) -> i32 {
    (*sd).chat_timer
}
pub unsafe fn sl_pc_set_chat_timer(sd: *mut MapSessionData, v: i32) {
    (*sd).chat_timer = v;
}
pub unsafe fn sl_pc_attacked(sd: *mut MapSessionData) -> i32 {
    (*sd).attacked as i32
}
pub unsafe fn sl_pc_set_attacked(sd: *mut MapSessionData, v: i32) {
    (*sd).attacked = v as i8;
}
pub unsafe fn sl_pc_loaded(sd: *mut MapSessionData) -> i32 {
    (*sd).loaded as i32
}
pub unsafe fn sl_pc_inventory_id(sd: *mut MapSessionData, pos: i32) -> u32 {
    (*sd).status.inventory[pos as usize].id as u32
}

// ─── Regen overflow accumulators and group membership ────────────────────────

pub unsafe fn sl_pc_set_vregenoverflow(sd: *mut MapSessionData, v: i32) {
    (*sd).vregenoverflow = v as f32;
}
pub unsafe fn sl_pc_set_mregenoverflow(sd: *mut MapSessionData, v: i32) {
    (*sd).mregenoverflow = v as f32;
}
pub unsafe fn sl_pc_set_group_count(sd: *mut MapSessionData, v: i32) {
    (*sd).group_count = v;
}
pub unsafe fn sl_pc_set_group_on(sd: *mut MapSessionData, v: i32) {
    (*sd).group_on = v;
}
pub unsafe fn sl_pc_set_group_leader(sd: *mut MapSessionData, v: i32) {
    (*sd).group_leader = v as u32;
}
pub unsafe fn sl_pc_group_count(sd: *mut MapSessionData) -> i32 {
    (*sd).group_count
}
pub unsafe fn sl_pc_group_on(sd: *mut MapSessionData) -> i32 {
    (*sd).group_on
}
pub unsafe fn sl_pc_group_leader(sd: *mut MapSessionData) -> i32 {
...
pub unsafe fn sl_pc_forcesave(sd: *mut MapSessionData) -> i32 {
    sl_intif_save(sd as *mut std::ffi::c_void)
}
...
pub unsafe fn sl_pc_showhealth(sd: *mut MapSessionData, damage: i32, kind: i32) {
    clif_send_pc_health(sd, damage, kind);
}
...
pub unsafe fn sl_pc_status(sd: *mut MapSessionData) -> i32 {
...
pub unsafe fn sl_pc_deductarmor(sd: *mut MapSessionData, v: i32) {
    clif_deductarmor(sd, v);
}

pub unsafe fn sl_pc_deductweapon(sd: *mut MapSessionData, v: i32) {
    clif_deductweapon(sd, v);
}

pub unsafe fn sl_pc_deductdura(sd: *mut MapSessionData, eq: i32, v: i32) {
    clif_deductdura(sd, eq, v);
}

pub unsafe fn sl_pc_deductduraequip(sd: *mut MapSessionData) {
    clif_deductduraequip(sd);
}

pub unsafe fn sl_pc_deductdurainv(sd: *mut MapSessionData, slot: i32, v: i32) {
    let sd = sd;
...
pub unsafe fn sl_pc_hasequipped(sd: *mut MapSessionData, item_id: u32) -> i32 {
    let sd = sd;
...
pub unsafe fn sl_pc_hasitem(sd: *mut MapSessionData, item_id: u32, amount: i32) -> i32 {
    let sd = sd;
    let mut found = 0i32;
...
pub unsafe fn sl_pc_powerboard(_sd: *mut MapSessionData) { /* stub */ }
...
pub unsafe fn sl_pc_removespell(sd: *mut MapSessionData, spell_id: i32) {
    let sd = sd;
    for i in 0..MAX_SPELLS {
...
pub unsafe fn sl_pc_addclan(_sd: *mut MapSessionData, _name: *const i8) { /* stub */ }

pub unsafe fn sl_pc_updatepath(sd: *mut MapSessionData, path: i32, mark: i32) {
    let id = (*sd).status.id;
...
pub unsafe fn sl_pc_updatecountry(sd: *mut MapSessionData, country: i32) {
    let id = (*sd).status.id;
    let _ = crate::database::blocking_run_async(async move {
...
pub unsafe fn sl_pc_setheroshow(sd: *mut MapSessionData, flag: i32) {
    let sd = sd;
...
pub unsafe fn sl_pc_removelegendbycolor(sd: *mut MapSessionData, color: i32) {
    let sd = sd;
    let legs = &mut (*sd).status.legends;
...
pub unsafe fn sl_pc_getpk(sd: *mut MapSessionData, id: i32) -> i32 {
    let sd = sd;
    for x in 0..20 {
...
pub unsafe fn sl_pc_vregenoverflow(sd: *mut MapSessionData) -> i32 {
    (*sd).vregenoverflow as i32
}

pub unsafe fn sl_pc_mregenoverflow(sd: *mut MapSessionData) -> i32 {
...
pub unsafe fn sl_pc_settimevalues(sd: *mut MapSessionData, newval: u32) {
    let sd = sd;
    if sd.is_null() { return; }
...
pub unsafe fn sl_pc_getequippeddura(sd: *mut MapSessionData, id: u32, slot: i32) -> i32 {
...
pub unsafe fn sl_pc_addguide(_sd: *mut MapSessionData, _guide: i32) {}
pub unsafe fn sl_pc_delguide(_sd: *mut MapSessionData, _guide: i32) {}
pub unsafe fn sl_pc_logbuysell(
    _sd: *mut MapSessionData, _item: u32, _amount: u32, _gold: u32, _flag: i32) {}
pub unsafe fn sl_pc_calcthrow(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_calcrangeddamage(_sd: *mut MapSessionData, _bl: *mut std::ffi::c_void) -> i32 { 0 }
pub unsafe fn sl_pc_calcrangedhit(_sd: *mut MapSessionData, _bl: *mut std::ffi::c_void) -> i32 { 0 }
...
pub unsafe fn sl_pc_checkbankitems(sd: *mut MapSessionData, slot: i32) -> i32 {
    let sd = sd;
    if sd.is_null() || slot < 0 || slot as usize >= MAX_BANK_SLOTS { return 0; }
    (*sd).status.banks[slot as usize].item_id as i32
}

pub unsafe fn sl_pc_checkbankamounts(sd: *mut MapSessionData, slot: i32) -> i32 {
    let sd = sd;
    if sd.is_null() || slot < 0 || slot as usize >= MAX_BANK_SLOTS { return 0; }
    (*sd).status.banks[slot as usize].amount as i32
}

pub unsafe fn sl_pc_checkbankowners(sd: *mut MapSessionData, slot: i32) -> i32 {
    let sd = sd;
    if sd.is_null() || slot < 0 || slot as usize >= MAX_BANK_SLOTS { return 0; }
    (*sd).status.banks[slot as usize].owner as i32
}

pub unsafe fn sl_pc_checkbankengraves(sd: *mut MapSessionData, slot: i32) -> *const i8 {
    let sd = sd;
...
pub unsafe fn sl_pc_hasitemdura(
    sd_ptr: *mut MapSessionData, id: u32, mut amount: u32,
) -> i32 {
    let sd = sd_ptr;
...
pub unsafe fn sl_pc_showbank_send(_sd: *mut MapSessionData, _msg: *const i8) {}
pub unsafe fn sl_pc_showbankadd_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_bankaddmoney_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_bankwithdrawmoney_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_clanshowbank_send(_sd: *mut MapSessionData, _msg: *const i8) {}
pub unsafe fn sl_pc_clanshowbankadd_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_clanbankaddmoney_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_clanbankwithdrawmoney_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_clanviewbank_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_repairextend_send(_sd: *mut MapSessionData) {}
pub unsafe fn sl_pc_repairall_send(_sd: *mut MapSessionData, _npc_bl: *mut std::ffi::c_void) {}
...
///
pub unsafe fn sl_pc_setpk(sd_ptr: *mut MapSessionData, id: i32) {
    let sd = sd_ptr;
    if sd.is_null() { return; }
    let mut exist = -1i32;
    for x in 0..20usize {
...
///
pub unsafe fn sl_pc_removehealth_nodmgnum(sd_ptr: *mut MapSessionData, damage: i32, type_: i32) {
    use crate::game::pc::PC_DIE;
    let sd = sd_ptr;
    if sd.is_null() { return; }
...
///
pub unsafe fn sl_pc_expireitem(sd_ptr: *mut MapSessionData) {
    let sd = sd_ptr;
    if sd.is_null() { return; }
...
///
pub unsafe fn sl_pc_addhealth2(sd_ptr: *mut MapSessionData, amount: i32, _type: i32) {
    let sd = sd_ptr;
    if sd.is_null() { return; }
