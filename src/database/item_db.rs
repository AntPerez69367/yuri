...
#[no_mangle]
pub extern "C" fn rust_itemdb_init() -> c_int { ffi_catch!(-1, init()) }

#[no_mangle]
pub extern "C" fn rust_itemdb_term() { ffi_catch!((), term()) }

#[no_mangle]
pub extern "C" fn rust_itemdb_search(id: c_uint) -> *mut ItemData { ffi_catch!(null_mut(), search(id)) }

#[no_mangle]
pub extern "C" fn rust_itemdb_searchexist(id: c_uint) -> *mut ItemData { ffi_catch!(null_mut(), searchexist(id)) }

#[no_mangle]
pub unsafe extern "C" fn rust_itemdb_searchname(s: *const c_char) -> *mut ItemData { ffi_catch!(null_mut(), unsafe { searchname(s) }) }

#[no_mangle]
pub unsafe extern "C" fn rust_itemdb_id(s: *const c_char) -> c_uint {
